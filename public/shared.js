...
{id: 'FrostlandsWyrm', name: 'Frostlands Wyrm', rarity: 'Common', image: 'CardImages/Frostlands/Frostlands Wyrm.png', 
 category: 'Creature', color: ['blue', 'gray'], type: 'Dragon', hp: 9, atk: 5, def: 2, cost: 3, archetype: 'Frostlands', ability: ['Ice Armor','Flying'], set: 'StandardPack'},
{id: 'FrostlandsGolem', name: 'Frostlands Golem', rarity: 'Common', image: 'CardImages/Frostlands/Frostlands Golem.png', 
...
{id: 'FrostlandsRuneforgedTitan', name: 'Frostlands Runeforged Titan', rarity: 'Epic', image: 'CardImages/Frostlands/Frostlands Runeforged Titan.png', 
...
{id: 'EirawenFrostlandsQueen', name: 'Eirawen, Frostlands Queen', rarity: 'Legendary', image: 'CardImages/Frostlands/Eirawen, Frostlands Queen.png', 
...
{id: 'GolemheartInfusor', name: 'Golemheart Infusor', rarity: 'Common', image: 'CardImages/Artifacts/Golemheart Infusor.png', 
 category: 'Artifact', color: 'gray', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Golemheart', ability: '', set: 'StandardPack'},
{id: 'HeartwoodEmeralds', name: 'Heartwood Emeralds', rarity: 'Common', image: 'CardImages/Artifacts/Heartwood Emeralds.png', 
 category: 'Artifact', color: 'green', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Heartwood', ability: '', set: 'StandardPack'},
{id: 'CindercoreEmber', name: 'Cindercore Ember', rarity: 'Common', image: 'CardImages/Artifacts/Cindercore Ember.png', 
 category: 'Artifact', color: 'red', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Cindercore', ability: '', set: 'StandardPack'},
{id: 'TidecallersPearl', name: 'Tidecallers Pearl', rarity: 'Common', image: 'CardImages/Artifacts/Tidecallers Pearl.png', 
 category: 'Artifact', color: 'blue', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Coralbound', ability: '', set: 'StandardPack'},
{id: 'StormcoreDynamo', name: 'Stormcore Dynamo', rarity: 'Common', image: 'CardImages/Artifacts/Stormcore Dynamo.png', 
 category: 'Artifact', color: 'yellow', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Stormcore', ability: '', set: 'StandardPack'},
{id: 'PlagueThornTalisman', name: 'Plague Thorn Talisman', rarity: 'Common', image: 'CardImages/Artifacts/Plague Thorn Talisman.png', 
 category: 'Artifact', color: 'purple', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: 'Plaguecore', ability: '', set: 'StandardPack'},
{id: 'TitansAnvil', name: 'Titans Anvil', rarity: 'Common', image: 'CardImages/Artifacts/Titans Anvil.png', 
 category: 'Artifact', color: 'gray', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: '', ability: '', set: 'StandardPack'},
{id: 'VeiloftheForgotten', name: 'Veil of the Forgotten', rarity: 'Common', image: 'CardImages/Artifacts/Veil of the Forgotten.png', 
 category: 'Artifact', color: 'black', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: '', ability: '', set: 'StandardPack'},
{id: 'LumenSpire', name: 'Lumen Spire', rarity: 'Common', image: 'CardImages/Artifacts/Lumen Spire.png', 
 category: 'Artifact', color: 'white', type: ['Artifact','Relic'], hp: 5, cost: 1, archetype: '', ability: '', set: 'StandardPack'},
