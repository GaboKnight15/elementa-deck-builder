...
{id: 'VerdaraSoldier', name: 'Verdara Soldier', rarity: 'Rare', image: 'Cards/egg/VerdaraSoldier.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Human', trait: 'Warrior', hp: 5, atk: 3, def: 1, cost: '{2}', 
...
{id: 'ElementalofFoliages', name: 'Elemental of Foliages', rarity: 'Rare', image: 'Cards/egg/ElementalofFoliages.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: 'Arbor', trait: 'Arbor', hp: 8, atk: 2, def: 0,
...
{id: 'ElementalofLeaves', name: 'Elemental of Leaves', rarity: 'Common', image: 'Cards/egg/ElementalofLeaves.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: 'Arbor', trait: 'Arbor', hp: 5, atk: 1, def: 0, cost: '{g}', 
...
{id: 'WildwoodGoblin', name: 'Wildwood Goblin', rarity: 'Common', image: 'Cards/egg/WildwoodGoblin.png', flavor: '',
 category: 'Creature', color: 'Green', type: 'Goblin', archetype: '', hp: 3, atk: 1, def: 0,
 cost: '{0}', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'WildHuntress', name: 'Wild Huntress', rarity: 'Common', image: 'Cards/egg/WildHuntress.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', trait: 'Warrior', hp: 4, atk: 2, def: 1,
...
{id: 'FaunRanger', name: 'Faun Ranger', rarity: 'Common', image: 'Cards/egg/FaunRanger.png', flavor: 'Each arrow is a promise kept. No trespasser leaves the forest unmarked.', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', trait: 'Ranger', hp: 3, atk: 2, def: 0,
...
{id: 'FaunDiviner', name: 'Faun Diviner', rarity: 'Common', image: 'Cards/egg/FaunDiviner.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', trait: 'Mage', hp: 4, atk: 1, def: 0,
...
{id: 'Forest', name: 'Forest', rarity: 'Common', image: 'Cards/egg/Forest.png', flavor: '', 
 category: 'Terrain', color: 'Green', type: '', hp: 5, cost: '{1}', essence: '{G}', set: 'ElementaGenesis',
...
{id: 'FlourishingVitality', name: 'Flourishing Vitality', rarity: 'Common', image: 'Cards/egg/FlourishingVitality.png', flavor: '', 
 category: 'Spell', color: 'Green', type: '', trait: 'Nature', cost: '{g}', set: 'ElementaGenesis',
...
{id: 'InfernoEruption', name: 'Inferno Eruption', rarity: 'Legend', image: 'Cards/egr/InfernoEruption.png', flavor: '', 
 category: 'Spell', color: 'Red', type: '', trait: 'Fire', cost: '{2}{r}', set: 'ElementaGenesis',
...
{id: 'BlazescaleWarDrake', name: 'Blazescale War-Drake', rarity: 'Rare', image: 'Cards/egr/BlazescaleWarDrake.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Dragon', archetype: '', trait: '', hp: 7, atk: 4, def: 1,
...
{id: 'ElementalofFlames', name: 'Elemental of Flames', rarity: 'Rare', image: 'Cards/egr/ElementalofFlames.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Elemental', archetype: 'Pyro', trait: 'Fire', hp: 5, atk: 4, def: 0,
 cost: '{2}{r}', ability: ['Elusive','Scorch'], set: 'ElementaGenesis',
 skill: [{name: 'Inferno Discovery', cost: '{2}{r}',
...
{id: 'MagmarisMercenary', name: 'Magmaris Mercenary', rarity: 'Rare', image: 'Cards/egr/MagmarisMercenary.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Human', archetype: '', trait: 'Warrior', hp: 5, atk: 2, def: 1,
...
{id: 'EmberstormCyclone', name: 'Emberstorm Cyclone', rarity: 'Rare', image: 'Cards/egr/EmberstormCyclone.png', flavor: '', 
 category: 'Spell', color: 'Red', type: '', trait: 'Fire', cost: '{1}{r}', set: 'ElementaGenesis',
...
{id: 'ElementalofEmbers', name: 'Elemental of Embers', rarity: 'Common', image: 'Cards/egr/ElementalofEmbers.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Elemental', archetype: 'Pyro', trait: 'Fire', hp: 3, atk: 2, def: 0,
 cost: '{r}', ability: ['Elusive','Scorch'], set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{r}', effect: {class: 'Summon'}}]},

{id: 'Kobold', name: 'Kobold', rarity: 'Common', image: 'Cards/egr/Kobold.png', flavor: '',
 category: 'Creature', color: 'Red', type: 'Kobold', archetype: '', hp: 3, atk: 2, def: 1,
...
{id: 'Umarion', name: 'Umarion', rarity: 'Legend', image: 'Cards/egu/Umarion.png', flavor: '', 
 category: 'Terrain', color: 'Blue', type: '', hp: 20, cost: '{0}', essence: '{U}', trait: 'Dominion', set: 'ElementaGenesis',
...
{id: 'GiantMaelstromSquid', name: 'Giant Maelstrom-Squid', rarity: 'Rare', image: 'Cards/egu/GiantMaelstromSquid.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', archetype: '', trait: 'Oceanic', hp: 9, atk: 4, def: 0,
...
{id: 'WavecrashWhale', name: 'Wavecrash Whale', rarity: 'Rare', image: 'Cards/egu/WavecrashWhale.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', trait: 'Oceanic', hp: 12, atk: 5, def: 0,
...
{id: 'ElementalofTorrents', name: 'Elemental of Torrents', rarity: 'Rare', image: 'Cards/egu/ElementalofTorrents.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Elemental', archetype: 'Hydral', trait: 'Water', hp: 8, atk: 3, def: 0,
...
{id: 'ElementalofDroplets', name: 'Elemental of Droplets', rarity: 'Common', image: 'Cards/egu/ElementalofDroplets.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Elemental', archetype: 'Hydral', trait: 'Water', hp: 4, atk: 1, def: 0,
...
{id: 'Dolphin', name: 'Dolphin', rarity: 'Common', image: 'Cards/egu/Dolphin.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', trait: 'Oceanic', hp: 5, atk: 1, def: 0,
...
{id: 'RuneboundShark', name: 'Runebound Shark', rarity: 'Common', image: 'Cards/egu/RuneboundShark.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', trait: 'Oceanic', hp: 4, atk: 3, def: 0,
 cost: '{1}{u}', ability: 'Dive', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{1}{u}', effect: {class: 'Summon'}},
	{name: 'Frenzy', activation: {class:'Frenzy'}, effect: {class: 'Frenzy'}},
...
{id: 'Ocean', name: 'Ocean', rarity: 'Common', image: 'Cards/egu/Ocean.png', flavor: '', 
 category: 'Terrain', color: 'Blue', type: '', hp: 5, cost: '{1}', essence: '{u}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{1}', effect: {class: 'Terraform'}}]},
...
{id: 'Aetherion', name: 'Aetherion', rarity: 'Legend', image: 'Cards/egy/Aetherion.png', flavor: '', 
 category: 'Terrain', color: 'Yellow', type: '', hp: 20, cost: '{0}', essence: '{y}', trait: 'Dominion', set: 'ElementaGenesis',
...
{id: 'TempestDevastation', name: 'Tempest Devastation', rarity: 'Legend', image: 'Cards/egy/TempestDevastation.png', flavor: '', 
 category: 'Spell', color: 'Yellow', type: '', trait: 'Thunder', cost: '{2}{y}', set: 'ElementaGenesis',
...
{id: 'ElementalofGales', name: 'Elemental of Gales', rarity: 'Rare', image: 'Cards/egy/ElementalofGales.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Elemental', archetype: '', trait: 'Wind', hp: 5, atk: 3, def: 0,
...
{id: 'ElementalofLightning', name: 'Elemental of Lightning', rarity: 'Rare', image: 'Cards/egy/ElementalofLightning.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Elemental', archetype: '', trait: 'Thunder', hp: 4, atk: 3, def: 0,
...
{id: 'StormspirePinnacle', name: 'Stormspire Pinnacle', rarity: 'Rare', image: 'Cards/egy/StormspirePinnacle.png', flavor: '', 
 category: 'Terrain', color: 'Yellow', type: '', trait: 'Thunder', hp: 8, cost: '{y}', ability: 'Static', essence: '{Y}', set: 'ElementaGenesis',
...
{id: 'PiercingLightning', name: 'Piercing Lightning', rarity: 'Rare', image: 'Cards/egy/PiercingLightning.png', flavor: '', 
 category: 'Spell', color: 'Yellow', type: '', trait: 'Thunder', cost: '{1}{y}', set: 'ElementaGenesis',
...
{id: 'ElementalofSparks', name: 'Elemental of Sparks', rarity: 'Common', image: 'Cards/egy/ElementalofSparks.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Elemental', archetype: '', trait: 'Thunder', hp: 2, atk: 2, def: 0,
...
{id: 'ZephyrSprite', name: 'Zephyr Sprite', rarity: 'Common', image: 'Cards/egy/ZephyrSprite.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Elemental', archetype: '', trait: 'Wind', hp: 2, atk: 2, def: 0,
 cost: '{y}', ability: 'Flying', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{y}', effect: {class: 'Summon'}}]},

{id: 'Peaks', name: 'Peaks', rarity: 'Common', image: 'Cards/egy/Peaks.png', flavor: '', 
 category: 'Terrain', color: 'Yellow', type: '', hp: 5, cost: '{0}', essence: '{Y}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{0}', effect: {class: 'Terraform'}}]},
...
{id: 'Drakzul', name: 'Drakzul', rarity: 'Legend', image: 'Cards/egc/Drakzul.png', flavor: '', 
 category: 'Terrain', color: 'Gray', type: '', hp: 20, cost: '{0}', essence: '{C}', trait: 'Dominion', set: 'ElementaGenesis',
...
{id: 'RockmaulRhino', name: 'Rockmaul Rhino', rarity: 'Rare', image: 'Cards/egc/RockmaulRhino.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Beast', trait: 'Brute', hp: 7, atk: 4, def: 2,
...
{id: 'ElementalofBoulders', name: 'Elemental of Boulders', rarity: 'Rare', image: 'Cards/egc/ElementalofBoulders.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Elemental', archetype: '', trait: 'Golem', hp: 4, atk: 4, def: 2,
...
{id: 'SlatebackLizard', name: 'Slateback Lizard', rarity: 'Rare', image: 'Cards/egc/SlatebackLizard.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Reptile', trait: 'Brute', hp: 5, atk: 4, def: 1,
...
{id: 'RockshellArmadillo', name: 'Rockshell Armadillo', rarity: 'Common', image: 'Cards/egc/RockshellArmadillo.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Beast', archetype: '', trait: '', hp: 2, atk: 1, def: 2,
...
{id: 'Mountain', name: 'Mountain', rarity: 'Common', image: 'Cards/egc/Mountain.png', flavor: '', 
 category: 'Terrain', color: 'Gray', type: '', hp: 5, cost: '{1}', essence: '{c}', set: 'ElementaGenesis',
...
{id: 'MordrathVirkulPhantom', name: 'Mordrath, Virkul Phantom', rarity: 'Legend', image: 'Cards/egp/MordrathVirkulPhantom.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Undead', archetype: '', trait: ['Spirit', 'Warrior'], hp: 4, atk: 2, def: 1,
...
{id: 'CursedWorldfall', name: 'Cursed Worldfall', rarity: 'Legend', image: 'Cards/egp/CursedWorldfall.png', flavor: '', 
 category: 'Spell', color: 'Purple', type: 'Aura', trait: 'Cursed', cost: '{1}{p}', set: 'ElementaGenesis',
...
{id: 'GoliathCroaker', name: 'Goliath Croaker', rarity: 'Rare', image: 'Cards/egp/GoliathCroaker.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Beast', archetype: '', trait: '', hp: 9, atk: 3, def: 0,
...
{id: 'DreadcoilViper', name: 'Dreadcoil Viper', rarity: 'Rare', image: 'Cards/egp/DreadcoilViper.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Reptile', archetype: '', trait: '', hp: 5, atk: 3, def: 1,
...
{id: 'ElementalofMiasmas', name: 'Elemental of Miasmas', rarity: 'Rare', image: 'Cards/egp/ElementalofMiasmas.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Elemental', archetype: 'Corruptor', trait: 'Toxic', hp: 7, atk: 3, def: 0,
...
{id: 'ElementalofToxins', name: 'Elemental of Toxins', rarity: 'Common', image: 'Cards/egp/ElementalofToxins.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Elemental', archetype: 'Corruptor', trait: 'Toxic', hp: 4, atk: 1, def: 0,
...
{id: 'Pegasus', name: 'Pegasus', rarity: 'Rare', image: 'Cards/egw/Pegasus.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Beast', trait: 'Mythic', hp: 6, atk: 3, def: 0,
...
{id: 'ElementalofLusters', name: 'Elemental of Lusters', rarity: 'Rare', image: 'Cards/egw/ElementalofLusters.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Elemental', archetype: 'Luminaut', trait: 'Light', hp: 7, atk: 3, def: 0,
...
{id: 'ElementalofGleams', name: 'Elemental of Gleams', rarity: 'Common', image: 'Cards/egw/ElementalofGleams.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Elemental', archetype: 'Luminaut', trait: 'Light', hp: 3, atk: 1, def: 0,
...
{id: 'SunbatheHills', name: 'Sunbathe Hills', rarity: 'Common', image: 'Cards/egw/SunbatheHills.png', flavor: '', 
 category: 'Terrain', color: 'White', type: '', hp: 8, cost: '{1}', essence: '{w}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{1}', effect: {class: 'Terraform'}}]},
...
{id: 'HaloFlare', name: 'Halo Flare', rarity: 'Common', image: 'Cards/egw/HaloFlare.png', flavor: '', 
 category: 'Spell', color: 'White', type: '', trait: 'Light', cost: '{1}{w}', set: 'ElementaGenesis',
...
{id: 'BroodTyrant', name: 'Brood Tyrant', rarity: 'Rare', image: 'Cards/egb/BroodTyrant.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Dragon', archetype: '', trait: 'Dark', hp: 6, atk: 4, def: 1,
...
{id: 'GraveweaverWarlock', name: 'Graveweaver Warlock', rarity: 'Rare', image: 'Cards/egb/GraveweaverWarlock.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Orc', archetype: '', trait: 'Mage', hp: 6, atk: 3, def: 0,
 cost: '{2}{b}', ability: '', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{2}{b}', effect: {class: 'Summon'}},
  {name:'Lifetithe', cost: '{B}',
   requirement: {class:'CW'}, 
...
{id: 'ElementalofShadows', name: 'Elemental of Shadows', rarity: 'Rare', image: 'Cards/egb/ElementalofShadows.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Elemental', archetype: 'Obscurid', trait: 'Shadow', hp: 5, atk: 3, def: 0,
...
{id: 'ElementalofShades', name: 'Elemental of Shades', rarity: 'Common', image: 'Cards/egb/ElementalofShades.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Elemental', archetype: 'Obscurid', trait: 'Shadow', hp: 3, atk: 2, def: 0,
...
{id: 'ShadowLeech', name: 'Shadow Leech', rarity: 'Common', image: 'Cards/egb/ShadowLeech.png', flavor: '', 
 category: 'Spell', color: 'Black', type: '', trait: 'Shadow', cost: '{b}', set: 'ElementaGenesis',
...
{id: 'EssencePurge', name: 'Essence Purge', rarity: 'Common', image: 'Cards/egb/EssencePurge.png', flavor: '', 
 category: 'Spell', color: 'Black', type: '', cost: '{1}', set: 'ElementaGenesis',
 skill: [{name: 'Cast', cost: '{1}', effect: [{class: 'Dissolve', target: 1}, {class: 'Cast'}]}]},

// FRACTURED ORIGINS //

{id: 'VerdarokSylvanThornwing', name: 'Verdarok, Sylvan Thornwing', rarity: 'Legend', image: 'Cards/Thornwing/VerdarokSylvanThornwing.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Dragon', archetype: 'Thornwing', trait: 'Evolution', hp: 9, atk: 5, def: 1,
 cost: '{5}{g}', ability: ['Flying','Protect'], set: 'FracturedOrigins',
 skill: [
...
{id: 'ThicketmistDrakeling', name: 'Thicketmist Drakeling', rarity: 'Legend', image: 'Cards/Thornwing/ThicketmistDrakeling.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Dragon', archetype: 'Thornwing', hp: 4, atk: 2, def: 1,
 cost: '{1}{g}', ability: ['Flying','Protect'], set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{1}{g}', effect: {class: 'Summon'}},
  {name: 'Reveal', cost: '{g}',
...
{id: 'VerdantLindwurm', name: 'Verdant Lindwurm', rarity: 'Legend', image: 'Cards/Thornwing/VerdantLindwurm.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Dragon', archetype: 'Thornwing', hp: 4, atk: 2, def: 1,
 cost: '{1}{G}', ability: ['Flying','Protect'], set: 'FracturedOrigins',
 skill: [
  {name: 'Reveal', cost: '{g}',
...
{id: 'PyronyxInfernoBlazingscale', name: 'Pyronyx, Inferno Blazingscale', rarity: 'Legend', image: 'Cards/Blazingscale/PyronyxInfernoBlazingscale.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Dragon', archetype: 'Blazingscale', trait: 'Evolution', hp: 7, atk: 4, def: 1,
...
{id: 'PyronyxEmberBreeze', name: 'Pyronyx, Ember Breeze', rarity: 'Rare', image: 'Cards/Blazingscale/PyronyxEmberBreeze.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Dragon', archetype: 'Blazingscale', trait: 'Fire', hp: 3, atk: 2, def: 1,
 cost: '{1}{r}', ability: 'Flying', set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{r}', effect: {class: 'Summon'}},
...
{id: 'AbyndraTidalAbyssdrake', name: 'Abyndra, Tidal Abyssdrake', rarity: 'Legend', image: 'Cards/Abyssdrake/AbyndraTidalAbyssdrake.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Dragon', archetype: 'Abyssdrake', trait: 'Evolution', hp: 10, atk: 4, def: 1,
 cost: '{5}{u}', ability: ['Flying','Veil'], set: 'FracturedOrigins',
...
{id: 'AbyndraRipplefinGloomlet', name: 'Abyndra, Ripplefin Gloomlet', rarity: 'Rare', image: 'Cards/Abyssdrake/AbyndraRipplefinGloomlet.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Dragon', archetype: 'Abyssdrake', trait: 'Water', hp: 5, atk: 2, def: 1,
...
{id: 'VoltrazekTempestStormrazor', name: 'Voltrazek, Tempest Stormrazor', rarity: 'Legend', image: 'Cards/Stormrazor/VoltrazekTempestStormrazor.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Dragon', archetype: 'Stormrazor', trait: 'Evolution', hp: 8, atk: 4, def: 2,
 cost: '{4}{y}', ability: 'Flying', set: 'FracturedOrigins',
 skill: [
  {name: 'Reveal', cost: '{y}',
   requirement: {class: 'Reveal'},
...
{id: 'VoltrazekSparkletStormling', name: 'Voltrazek, Sparklet Stormling', rarity: 'Rare', image: 'Cards/Stormrazor/VoltrazekSparkletStormling.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Dragon', archetype: 'Stormrazor', trait: 'Thunder', hp: 3, atk: 2, def: 1,
...
{id: 'MyxarothCursedDreadspine', name: 'Myxaroth, Cursed Dreadspine', rarity: 'Legend', image: 'Cards/Dreadspine/MyxarothCursedDreadspine.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Dragon', trait: 'Evolution', hp: 7, atk: 4, def: 1,
 cost: '{4}{p}', archetype: 'Dreadspine', ability: ['Flying','Venom'], set: 'FracturedOrigins',
 skill: [
  {name: 'Discard', cost: '{p}',
...
{id: 'MyxarothToxletMireling', name: 'Myxaroth, Toxlet Mireling', rarity: 'Rare', image: 'Cards/Dreadspine/MyxarothToxletMireling.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Dragon', archetype: 'Dreadspine', trait: 'Cursed', hp: 3, atk: 2, def: 1,
 cost: '{1}{p}', ability: ['Flying','Venom'], set: 'FracturedOrigins',
...
{id: 'FerronyxTerraIronclaw', name: 'Ferronyx, Terra Ironclaw', rarity: 'Legend', image: 'Cards/Terraclaw/FerronyxTerraIronclaw.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Dragon', archetype: 'Ironclaw', trait: 'Evolution', hp: 9, armor: 5, atk: 4, def: 3,
 cost: '{5}{c}', ability: ['Armor','Flying'], set: 'FracturedOrigins',
 skill: [
  {name: 'Reveal', cost: '{c}',
   requirement: {class: 'Reveal'},
   effect: {class: 'Armor'}},
...
{id: 'FerronyxShardletGrindlewyrm', name: 'Ferronyx, Shardlet Grindlewyrm', rarity: 'Rare', image: 'Cards/Terraclaw/FerronyxShardletGrindlewyrm.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Dragon', archetype: 'Ironclaw', trait: 'Steel', hp: 2, armor: 4, atk: 2, def: 4,
 cost: '{1}{c}', ability: ['Armor','Flying'], set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{1}{c}', effect: {class: 'Summon'}},
  {name: 'Reveal', cost: '{c}',
   requirement: {class: 'Reveal'},
   effect: {class: 'Armor'}},
...
{id: 'NoctyrosUmbralNightshroud', name: 'Noctyros, Umbral Nightshroud', rarity: 'Legend', image: 'Cards/Nightshroud/NoctyrosUmbralNightshroud.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Dragon', archetype: 'Nightshroud', trait: 'Evolution', hp: 7, atk: 4, def: 1,
 cost: '{4}{b}', ability: ['Flying','Dusk'], set: 'FracturedOrigins',
 skill: [
  {name: 'Discard', cost: '{B}',
   requirement: {class:'Discard'}, 
...
{id: 'NoctyrosDuskWhisper', name: 'Noctyros, Dusk Whisper', rarity: 'Rare', image: 'Cards/Nightshroud/NoctyrosDuskWhisper.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Dragon', archetype: 'Nightshroud', trait: 'Dark', hp: 3, atk: 2, def: 1,
 cost: '{1}{b}', ability: 'Flying', set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: 'Discard', cost: '{B}',
   requirement: {class:'Discard'}, 
   effect: {class: 'Mill', type: 'Dragon'}},
...
{id: 'CarrionCrow', name: 'CarrionCrow', rarity: 'Common', image: 'Cards/egb/CarrionCrow.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Avian', archetype: 'Duskwing', trait: 'Dark', trait: '', hp: 2, atk: 2, def: 0,
 cost: '{1}', ability: '', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{b}', effect: {class: 'Summon'}}]},

{id: 'SolarythRadiantSolarwyrm', name: 'Solaryth, Radiant Solarwyrm', rarity: 'Legend', image: 'Cards/Solarwyrm/SolarythRadiantSolarwyrm.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Dragon', archetype: 'Solarwyrm', trait: 'Evolution', hp: 8, atk: 4, def: 1,
 cost: '{5}{w}', ability: ['Flying','Aegis'], set: 'ScalesofRuin',
 skill: [
  {name: 'Seal', cost: '{W}{W}',
   requirement: {class: 'CCW'},
   effect: {class: 'Seal'}},
...
{id: 'SolarythGlintletDawnbloom', name: 'Solaryth, Glintlet Dawnbloom', rarity: 'Rare', image: 'Cards/Solarwyrm/SolarythGlintletDawnbloom.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Dragon', archetype: 'Solarwyrm', trait: 'Light', hp: 4, atk: 2, def: 1,
 cost: '{1}{w}', ability: ['Flying','Aegis'], set: 'WyrmheartAwakening',
 skill: [{name: 'Summon', cost: '{1}{w}', effect: {class: 'Summon'}},
  {name: 'Seal', cost: '{W}{W}',
   requirement: {class: 'CCW'},
   effect: {class: 'Seal'}},
...
{id: 'LyssaraScarletVindicator', name: 'Lyssara, Scarlet Vindicator', rarity: 'Legend', image: 'Cards/Fireland/LyssaraScarletVindicator.png', flavor: '', 
 category: 'Creature', color: ['Red','Gray'], type: 'Human', archetype: '', trait: 'Warrior', hp: 4, atk: 2, def: 1,
...
{id: 'KaelyraFirelandHeiress', name: 'Kaelyra, Fireland Heiress', rarity: 'Legend', image: 'Cards/Fireland/KaelyraFirelandHeiress.png', flavor: '', imageFullArt: 'Cards/Fireland/KaelyraFirelandHeiressFA.png', flavor: '',
 category: 'Creature', color: 'Red', type: 'Human', archetype: 'Fireland', trait: 'Mage', hp: 4, atk: 1, def: 0,
 cost: '{1}{r}', ability: 'Burn', set: 'Savage Territory',
 skill: [{name: 'Summon', cost: '{r}', effect: {class: 'Summon'}},
...
{id: 'VorgannaCrimsonBlade', name: 'Vorganna, Crimson Blade', rarity: 'Legend', image: 'Cards/Fireland/VorgannaCrimsonBlade.png', flavor: '', 
 category: 'Creature', color: ['Black','Red'], type: 'Human', trait: 'Warrior', hp: 4, atk: 3, def: 1,
 cost: '{b}{r}', ability: ['Burn','Rush'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{b}', effect: {class: 'Summon'}},
...
{id: 'TydrosCoralboundTidebreaker', name: 'Tydros, Coralbound Tidebreaker', rarity: 'Legend', image: 'Cards/Coralbound/TydrosCoralboundTidebreaker.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Merfolk', trait: 'Warrior', hp: 6, atk: 2, def: 0,
...
{id: 'AstranyraThunderbane', name: 'Astranyra, Thunderbane', rarity: 'Legend', image: 'Cards/Demon/AstranyraThunderbane.png', flavor: '', 
 ...
 skill: [{name: 'Summon', cost: '{y}', effect: {class: 'Summon'}},
  ...
  {name: 'Soulrend Sovereignty', cost: '{b}{B}',
   requirement: [{class: 'Special'}, {class:'Sacrifice', amount: 1}, {class: 'CW'}],
...
{id: 'VeniryssSpiderPrincess', name: 'Veniryss, Spider Princess', rarity: 'Legend', image: 'Cards/ecp/VeniryssSpiderPrincess.png', flavor: '', 
 ...
 cost: '{1}{p}', ability: 'Venom', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{g}', effect: {class: 'Summon'}},
...
{id: 'EcliphosAethercruxPrime', name: 'Ecliphos, Aethercrux Prime', rarity: 'Legend', image: 'Cards/ecw/EcliphosAethercruxPrime.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Construct', archetype: 'Lightforge', trait: 'Light', hp: 9, atk: 2, def: 1,
 cost: '{2}{w}', ability: ['Protect'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{2}{w}', effect: {class: 'Summon'}},
  {name: 'Featherfall Tempest', cost: '{Y}{W}',
   requirement: [{class: 'Special'}, {class: 'CCW'}],
   effect: {class: 'Strike', amount: 1, target: 3}}
...
{id: 'AethercruxParagon', name: 'Aethercrux Paragon', rarity: 'Rare', image: 'Cards/ecw/AethercruxParagon.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Construct', trait: 'Light', hp: 5, atk: 2, def: 2,
 cost: '{2}{w}', ability: ['Protect'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{2}{w}', effect: {class: 'Summon'}},
  {name: '', cost: '{Y}{W}',
   requirement: [{class: 'Special'}, {class: 'CCW'}],
...
{id: 'OrbitronExarch', name: 'Orbitron Exarch', rarity: 'Legend', image: 'Cards/ecw/OrbitronExarch.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Construct', trait: 'Light', hp: 9, atk: 2, def: 1,
 cost: '{3}{w}', ability: ['Protect'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{3}{w}', effect: {class: 'Summon'}},
  {name:'Dash', cost: '{w}',
   effect: {class: 'Dash'}},
  {name: 'Featherfall Tempest', cost: '{Y}{W}',
   requirement: [{class: 'Special'}, {class: 'CCW'}],
...
{id: 'GalaxionStrider', name: 'GalaxionStrider', rarity: 'Legend', image: 'Cards/ecw/GalaxionStrider.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Construct', archetype: 'Lightforge', trait: 'Light', hp: 2, atk: 2, def: 3,
 cost: '{1}{w}', ability: ['Protect'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{w}', effect: {class: 'Summon'}},
  {name:'Dash', cost: '{w}',
   effect: {class: 'Dash'}},
  {name: 'Featherfall Tempest', cost: '{Y}{W}',
...
{id: 'AngelicPaladin', name: 'Angelic Paladin', rarity: 'Common', image: 'Cards/fow/AngelicPaladin.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Construct', archetype: 'Lightforge', trait:  'Warrior', hp: 5, atk: 2, def: 0,
...
{id: 'NyzarielArchdemonDuchess', name: 'Nyzariel, Archdemon Duchess', rarity: 'Legend', image: 'Cards/fob/NyzarielArchdemonDuchess.png', flavor: '', 
 ...
 cost: '{1}{b}', ability: '', set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{b}', effect: {class: 'Summon'}},
  {name: '', cost: '{1}{b}',
   requirement: {class: 'CCW'},
   effect: {class: 'Burn', amount: 3}},
...
{id: 'ShadeWisp', name: 'Shade Wisp', rarity: 'Common', image: 'Cards/ecb/ShadeWisp.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Elemental', archetype: 'Obscurid', trait: 'Shadow', hp: 2, atk: 1, def: 0,
...
{id: 'ShadeReaver', name: 'Shade Reaver', rarity: 'Rare', image: 'Cards/ecb/ShadeReaver.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Elemental', archetype: 'Obscurid', trait: 'Shadow', hp: 4, atk: 3, def: 0,
...
{id: 'OrrkalDevouringIncarnate', name: "Orr'kal, Devouring Incarnate", rarity: 'Legend', image: 'Cards/ecb/OrrkalDevouringIncarnate.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Elemental', archetype: 'Obscurid', trait: 'Shadow', hp: 2, atk: 0, def: 0,
...
{id: 'ShadowgearScout', name: 'Shadowgear Scout', rarity: 'Rare', image: 'Cards/ecb/ShadowgearScout.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Construct', archetype: 'Shadowgear', trait: 'Shadow', hp: 2, atk: 2, def: 3,
...
{id: 'ShadowgearAutomaton', name: 'Shadowgear Automaton', rarity: 'Rare', image: 'Cards/ecb/ShadowgearAutomaton.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Construct', archetype: 'Shadowgear', trait: 'Shadow', hp: 2, atk: 2, def: 0,
 cost: '{b}{b}', ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: '', cost: '{b}',
   requirement: {class: 'CCW'},
...
{id: 'SummitWatcher', name: 'Summit Watcher', rarity: 'Common', image: 'Cards/Faefolk/SummitWatcher.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Satyr', archetype: '', hp: 4, atk: 1, def: 0,
...
{id: 'WildhornRavager', name: 'Wildhorn Ravager', rarity: 'Common', image: 'Cards/Faefolk/WildhornRavager.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Satyr', archetype: '', Trait: 'Brute', hp: 5, atk: 3, def: 1,
...
{id: 'ElderwoodOccultist', name: 'Elderwood Occultist', rarity: 'Common', image: 'Cards/Faefolk/ElderwoodOccultist.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Satyr', archetype: '', trait: 'Mage', hp: 4, atk: 2, def: 0,
...
{id: 'HeartwoodEmeralds', name: 'Heartwood Emeralds', rarity: 'Common', image: 'Cards/ecg/HeartwoodEmeralds.png', flavor: '', 
 category: 'Artifact', color: 'Green', type: 'Relic', archetype: '', hp: 8, cost: '{1}{g}', set: 'ElementaGenesis',
...
{id: 'EmeraldVeil', name: 'Emerald Veil', rarity: 'Rare', image: 'Cards/ecg/EmeraldVeil.png', flavor: '', 
 category: 'Terrain', color: 'Green', type: '', hp: 8, cost: '{g}', essence: '{G}', trait: 'Terrain', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{g}', effect: {class: 'Terraform'}},
  {name: 'Flourish', cost: '{g}', requirement: {class: 'CW'}, effect: {class: 'Search', trait: 'Terrain'}}]},

{id: 'FirePixie', name: 'Fire Pixie', rarity: 'Common', image: 'Cards/Faefolk/FirePixie.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Fairy', archetype: '', trait: 'Fire', hp: 2, atk: 1, def: 0,
...
{id: 'WaterElemental', name: 'Water Elemental', rarity: 'Common', image: 'Cards/fou/WaterElemental.png',  flavor: '',
 category: 'Creature', color: 'Blue', type: 'Elemental', archetype: 'Hydral', trait: 'Water', hp: 5, atk: 1, def: 0,
...
{id: 'GroveMage', name: 'Grove Mage', rarity: 'Rare', image: 'Cards/Arbor/GroveMage.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', trait: 'Mage', hp: 5, atk: 2, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{g}', effect: {class: 'Summon'}},
  {name: 'Bloomchant', requirement: {class: 'CW'},
   effect: {class: 'Essence', color: '{G}', amount: 1}}
...
{id: 'VerdantSage', name: 'Verdant Sage', rarity: 'Rare', image: 'Cards/ecg/VerdantSage.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: '', trait: 'Mage', hp: 5, atk: 2, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: 'Bloomchant', requirement: {class: 'CW'},
   effect: {class: 'Essence', color: '{G}', amount: 1}}
...
{id: 'VerdantGolemite', name: 'Verdant Golemite', rarity: 'Rare', image: 'Cards/ecg/VerdantGolemite.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: '', trait: 'Golem', hp: 5, atk: 2, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: 'Bloomchant',
   requirement: {class: 'CW'},
...
{id: 'SylvanManifestation', name: 'Sylvan Manifestation', rarity: 'Rare', image: 'Cards/ecg/SylvanManifestation.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: '', trait: 'Arbor', hp: 5, atk: 2, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{g}', effect: {class: 'Summon'}},
  {name: 'Bloomchant',
   requirement: {class: 'CW'},
...
{id: 'JadebarkWarden', name: 'Jadebark Warden', rarity: 'Rare', image: 'Cards/ecg/JadebarkWarden.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: '', trait: 'Warrior', hp: 5, atk: 2, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: 'Bloomchant',
   requirement: {class: 'CW'},
...
{id: 'ElarisGroveLeafcaller', name: 'Elaris, Grove Leafcaller', rarity: 'Legend', image: 'Cards/Arbor/ElarisGroveLeafcaller.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', trait: 'Mage', hp: 5, atk: 1, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
  {name: 'Bloomchant',
   requirement: {class: 'CW'},
...
{id: 'WoodlandCentaur', name: 'Woodland Centaur', rarity: 'Rare', image: 'Cards/dfg/WoodlandCentaur.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Beast', archetype: '', trait: 'Mythical', hp: 8, atk: 3, def: 2, cost: '{1}{G}', 
 ability: ['Leap','Rush'], set: 'DesolateFrontiers'},

{id: 'DragonEgg', name: 'Dragon Egg', rarity: 'Common', image: 'Cards/for/DragonEgg.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Dragon', hp: 1, atk: 0, def: 0, cost: '{0}', 
 archetype: '', ability: '', skill: 'Awaken', set: 'FracturedOrigins'},

{id: 'WaterWyrm', name: 'Water Wyrm', rarity: 'Common', image: 'Cards/fou/WaterWyrm.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: ['Dragon','Elemental'], archetype: ['Abyssdrake', 'Hydral'], trait: 'Water', hp: 6, atk: 2, def: 0,
...
{id: 'TreantWitch', name: 'Treant Witch', rarity: 'Rare', image: 'Cards/Arbor/TreantWitch.png', flavor: '', 
 category: 'Creature', color: ['Green','Black'], type: 'Elemental', trait: ['Arbor', 'Mage'], hp: 6, atk: 1, def: 1, cost: '{1}{g}', 
  ability: '', set: 'DesolateFrontiers',
 skill: [{name: 'Summon', cost: '{1}{b}', effect: {class: 'Summon'}},
...
{id: 'SacredKirin', name: 'Sacred Kirin', rarity: 'Rare', image: 'Cards/Hybrid/SacredKirin.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Beast', trait: 'Mythical', hp: 7, atk: 4, def: 1, cost: '{2}{W}', 
...
{id: 'Jackalope', name: 'Jackalope', rarity: 'Rare', image: 'Cards/Hybrid/Jackalope.png', flavor: '', 
 category: 'Creature', color: ['Green','Black'], type: 'Beast', archetype: '', trait: 'Mythical', hp: 4, atk: 2, def: 0,
...
{id: 'FirelandCindercub', name: 'Fireland Cindercub', rarity: 'Common', image: 'Cards/Beast/FirelandCindercub.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Beast', archetype: 'Fireland', trait: 'Fire', hp: 2, atk: 2, def: 0,
...
{id: 'FirelandHellhound', name: 'Fireland Hellhound', rarity: 'Rare', image: 'Cards/Beast/FirelandHellhound.png', flavor: '', 
 category: 'Creature', color: ['Red','Black'], type: ['Beast','Demon'], archetype: 'Fireland', trait: 'Fire', hp: 6, atk: 3, def: 0,
...
{id: 'FirelandHellmaw', name: 'Fireland Hellmaw', rarity: 'Rare', image: 'Cards/Beast/Fireland Hellmaw.png', flavor: '', 
 category: 'Creature', color: ['Red','Black'], type: ['Dragon','Demon'], archetype: 'Fireland', trait: 'Fire', hp: 6, atk: 4, def: 1,
...
{id: 'EphorosFirelandBehemoth', name: 'Ephoros, Fireland Behemoth', rarity: 'Legend', image: 'Cards/Beast/EphorosFirelandBehemoth.png', flavor: '', imageFullArt: 'Cards/Fireland/EphorosFirelandBehemothFA.png', flavor: '',
 category: 'Creature', color: ['Red','Black'], type: ['Beast','Demon'], trait: 'Fire', hp: 9, atk: 5, def: 0,
 cost: '{5}{r}', ability: ['Burn','Crush'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{5}{r}', effect: {class: 'Summon'}},
  {name: 'Infernal Volley', cost: '{r}', description: 'Discard to burn {3}',
   requirement: {class: 'Discard'},
   effect: {class: 'Burn', amount: 3}},
  {name: 'Hellflame Onslaught', cost: '{r}{b}', description: 'Rally {1} to allied fire beasts and demons',
   requirement: {class: 'Special'},
...
{id: 'FireGolem', name: 'Fire Golem', rarity: 'Common', image: 'Cards/Golem/FireGolem.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', trait: ['Golem', 'Fire'], hp: 3, atk: 1, def: 2,
...
{id: 'KaelgorranElementalPrimordial', name: 'Kaelgorran, Elemental Primordial', rarity: 'Legend', image: 'Cards/foc/KaelgorranElementalPrimordial.png', flavor: '', imageFullArt: 'Cards/Golems/KaelgorranElementalPrimordialFA.png', flavor: '',
 category: 'Creature', color: ['Gray'], type: 'Elemental', trait' ['Golem', 'Fusion'], hp: 7, atk: 4, def: 2, cost: '{5}{c}',
 ability: '', set: 'PrimordialAscension',
...
{id: 'CindercoreProtector', name: 'Cindercore Protector', rarity: 'Rare', image: 'Cards/ecr/CindercoreProtector.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', trait: 'Fire', hp: 4, atk: 2, def: 2,
...
{id: 'CinderGolem', name: 'Cinder Golem', rarity: 'Rare', image: 'Cards/Construct/CinderGolem.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', trait: ['Golem', 'Fire'], hp: 15, atk: 6, def: 3,
...
{id: 'IgnavarynCindercoreAutomaton', name: 'Ignavaryn, Cindercore Automaton', rarity: 'Legend', image: 'Cards/ecr/IgnavarynCindercoreAutomaton.png', flavor: '', 
 ...
 cost: '{5}{r}', ability: 'Exploit', set: 'IronbornProtocol',
 skill: [{name: 'Assemble', cost: '{r}{r}', effect: {class: 'Assemble'}},
  {name: 'Stash', cost: '{5}{r}', description: 'Return from your hand to your deck and burn {2}',
   requirement: {class: 'Stash'},
...
{id: 'FairyDragon', name: 'Fairy Dragon', rarity: 'Rare', image: 'Cards/Dragon/FairyDragon.png', flavor: '', 
 category: 'Creature', color: ['Green', 'Red', 'White'], type: 'Dragon', hp: 4, atk: 1, def: 1, cost: '{g}',
 ability: 'Flying', set: 'MischiefUnbound',
 skill: [{name: 'Summon', cost: '{2}{g}', effect: {class: 'Summon'}},
  {name: 'Purify', cost: '{W}',
   requirement: {class: 'CW'},
   effect: {class: 'Purify'}},
...
{id: 'Werewolf', name: 'Werewolf', rarity: 'Common', image: 'Cards/dfb/Werewolf.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Beast', trait: ['Brute', 'Dark'], hp: 6, atk: 3, def: 1,
...
{id: 'XulZulSkullframeEternal', name: "Xul'Zul, Skullframe Eternal", rarity: 'Legend', image: 'Cards/fop/XulZulSkullframeEternal.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: ['Dragon','Undead'], hp: 8, atk: 5, def: 1,
  cost: '{4}{p}', ability: ['Flying', 'Immunity'], set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{4}{p}', effect: {class: 'Summon'}},
...
{id: 'SkullframeArmoredDragon', name: 'Skullframe Armored Dragon', rarity: 'Rare', image: 'Cards/fob/SkullframeArmoredDragon.png', flavor: '', 
 category: 'Creature', color: 'Black', type: ['Dragon','Undead'], hp: 5, armor: 2, atk: 4, def: 1,
 cost: '{2}{b}', ability: ['Flying','Immunity','Armor'], set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
...
{id: 'SkullframeHexmistress', name: 'Skullframe Hexmistress', rarity: 'Rare', image: 'Cards/fob/SkullframeHexmistress.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: 'Undead', trait: 'Mage', hp: 3, atk: 2, def: 0,
 cost: '{1}{b}', ability: 'Immunity', set: 'FracturedOrigins',
...
{id: 'MaldryssSkullframeArchmage', name: 'Maldryss, Skullframe Archmage', rarity: 'Legend', image: 'Cards/fob/MaldryssSkullframeArchmage.png', flavor: '', imageFullArt: 'Cards/Skullframe/MaldryssSkullframeArchmageFA.png', flavor: '',
 ...
 cost: '{1}{b}{p}', ability: ['Drain','Immunity'], set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{b}{p}', effect: {class: 'Summon'}},
...
{id: 'Witherwake', name: 'Witherwake', rarity: 'Common', image: 'Cards/fop/Witherwake.png', flavor: '', 
 category: 'Spell', color: ['Black','Purple'], type: 'Spell', cost: '{1}{p}{b}', set: 'FracturedOrigins',
...
{id: 'FrostlandDragon', name: 'Frostland Dragon', rarity: 'Rare', image: 'Cards/ecu/FrostlandDragon.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Dragon', trait: 'Ice', hp: 9, atk: 5, def: 2,
...
{id: 'FrostlandWyrm', name: 'Frostland Wyrm', rarity: 'Common', image: 'Cards/ecu/FrostlandWyrm.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Dragon', trait: 'Ice', hp: 4, atk: 2, def: 2,
 cost: '{u}{c}', archetype: 'Frostland', ability: ['Ice Armor','Flying'], set: 'EchoesofCreation',
...
{id: 'FrostlandGolem', name: 'Frostland Golem', rarity: 'Common', image: 'Cards/ecu/FrostlandGolem.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Elemental', trait: ['Golem', 'Ice'], hp: 5, atk: 3, def: 3,
 cost: '{1}{u}{c}', ability: 'Ice Armor', set: 'EchoesofCreation',
...
{id: 'FrostlandPhoenix', name: 'Frostland Phoenix', rarity: 'Common', image: 'Cards/ecu/FrostlandPhoenix.png', flavor: '', 
 ...
 cost: '{u}{c}', ability: ['Ice Armor','Flying'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
  {name: 'Echo', 
   activation: {class: 'Echo'}, 
...
{id: 'FrostlandRuneforgedAutomaton', name: 'Frostland Runeforged Automaton', rarity: 'Rare', image: 'Cards/ecu/FrostlandRuneforgedAutomaton.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Construct', trait: 'Ice', hp: 5, atk: 5, def: 3,
 cost: '{2}{U}{C}', ability: ['Crush','Exploit'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},
...
{id: 'KryxalonFrostRuneforgedColossus', name: 'Kryxalon, Frost Runeforged Colossus', rarity: 'Legend', image: 'Cards/ecu/KryxalonFrostRuneforgedColossus.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Construct', trait: ['Assembly', 'Ice'], hp: 5, atk: 5, def: 3,
 cost: '{4}{u}{c}', ability: ['Crush', 'Exploit'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
 {name: 'Assemble', cost: '{0}', effect: {class: 'Summon'}},]},

{id: 'EirawenFrostlandQueen', name: 'Eirawen, Frostland Queen', rarity: 'Legend', image: 'Cards/ecu/EirawenFrostlandQueen.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Elf', trait: ['Ice', 'Mage'], hp: 4, atk: 1, def: 1,
 cost: '{1}{u}{c}', ability: 'Frost', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{1}{u}{c}', effect: {class: 'Summon'}}]},

// ARTIFACTS //
{id: 'GolemheartInfusor', name: 'Golemheart Infusor', rarity: 'Common', image: 'Cards/foc/GolemheartInfusor.png', flavor: '', 
 category: 'Artifact', color: 'Gray', type: 'Relic', hp: 5, cost: '{c}', archetype: 'Golemheart', set: 'FracturedOrigins',
...
{id: 'CindercoreEmber', name: 'Cindercore Ember', rarity: 'Common', image: 'Cards/Artifact/CindercoreEmber.png', flavor: '', 
 category: 'Artifact', color: 'Red', type: 'Relic', archetype: 'Cindercore', trait: 'Fire', hp: 7, cost: '{1}{R}', set: 'ElementaGenesis',
...
{id: 'TidecallersPearl', name: 'Tidecallers Pearl', rarity: 'Common', image: 'Cards/Artifact/TidecallersPearl.png', flavor: '', 
 category: 'Artifact', color: 'Blue', type: 'Relic', hp: 5, cost: '{2}{U}', archetype: 'Coralbound', trait: 'Water', set: 'ElementaGenesis',
 skill: [{name: 'Equip', cost: '{0}', effect: {class: 'Equip'}}]},
{id: 'StormcoreDynamo', name: 'Stormcore Dynamo', rarity: 'Common', image: 'Cards/Artifact/StormcoreDynamo.png', flavor: '', 
 category: 'Artifact', color: 'Yellow', type: 'Relic', archetype: 'Stormcore', trait: 'Thunder', hp: 5, cost: '{2}{Y}', set: 'ElementaGenesis',
 skill: [{name: 'Equip', cost: '{0}', effect: {class: 'Equip'}}]},
{id: 'PlagueThornTalisman', name: 'Plague Thorn Talisman', rarity: 'Common', image: 'Cards/Artifact/PlagueThornTalisman.png', flavor: '', 
 category: 'Artifact', color: 'Purple', type: 'Relic', hp: 5, cost: '{2}{P}', archetype: 'Plaguecore', trait: 'Toxic', set: 'ElementaGenesis',
 skill: [{name: 'Equip', cost: '{0}', effect: {class: 'Equip'}}]},
...
{id: 'VeiloftheForgotten', name: 'Veil of the Forgotten', rarity: 'Common', image: 'Cards/Artifact/VeiloftheForgotten.png', flavor: '', 
 category: 'Artifact', color: 'Black', type: 'Relic', hp: 5, cost: '{2}{B}', archetype: '', trait: 'Dark', set: 'ElementaGenesis',
 skill: [{name: 'Equip', cost: '{0}', effect: {class: 'Equip'}}]},
{id: 'LumenSpire', name: 'Lumen Spire', rarity: 'Common', image: 'Cards/Artifact/Lumen Spire.png', flavor: '', 
 category: 'Artifact', color: 'White', type: 'Relic', hp: 5, cost: '{2}{W}', archetype: '', trait: 'Light', set: 'ElementaGenesis',
 skill: [{name: 'Equip', cost: '{0}', effect: {class: 'Equip'}}]},
...
{id: 'DragonsGrove', name: "Dragon's Grove", rarity: 'Rare', image: 'Cards/fog/DragonsGrove.png', flavor: '', 
 category: 'Terrain', color: 'Green', type: 'Dragon', trait: 'Nature', hp: 13, cost: '{2}{g}', essence: '{g}', set: 'FracturedOrigins',
...
{id: 'DragonsSpire', name: "Dragon's Spire", rarity: 'Rare', image: 'Cards/for/DragonsSpire.png', flavor: '', 
 category: 'Terrain', color: 'Red', type: 'Dragon', trait: 'Fire', hp: 11, cost: '{1}{r}', essence: '{r}', set: 'FracturedOrigins',
 skill: [{name: 'Terraform', cost: '{1}{r}', effect: {class: 'Terraform'}},
  {name: 'Dragon Summon', 
...
{id: 'DragonsAtoll', name: "Dragon's Atoll", rarity: 'Rare', image: 'Cards/fou/DragonsAtoll.png', flavor: '', 
 category: 'Terrain', color: 'Blue', type: 'Dragon', trait: 'Water', hp: 18, cost: '{3}{u}', essence: '{u}', set: 'FracturedOrigins',
  skill: [{name: 'Terraform', cost: '{3}{u}', effect: {class: 'Terraform'}},
...
{id: 'DragonsSkyreach', name: "Dragon's Skyreach", rarity: 'Rare', image: 'Cards/foy/DragonsSkyreach.png', flavor: '', 
 category: 'Terrain', color: 'Yellow', type: 'Dragon', trait: 'Thunder', hp: 11, cost: '{1}{y}', essence: '{y}', set: 'FracturedOrigins',
 skill: [{name: 'Terraform', cost: '{1}{y}', effect: {class: 'Terraform'}},
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsBastion', name: "Dragon's Bastion", rarity: 'Rare', image: 'Cards/foc/DragonsBastion.png', flavor: '', 
 category: 'Terrain', color: 'Gray', type: 'Dragon', trait: 'Steel', hp: 12, cost: '{2}{c}', essence: '{c}', set: 'FracturedOrigins',
 skill: [{name: 'Terraform', cost: '{2}{c}', effect: {class: 'Terraform'}},
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
  {name: 'Dragon Echo', cost: '{u}',
...
{id: 'DragonsHollow', name: "Dragon's Hollow", rarity: 'Rare', image: 'Cards/fop/DragonsHollow.png', flavor: '', 
 category: 'Terrain', color: 'Purple', type: 'Dragon', trait: 'Cursed', hp: 12, cost: '{p}', essence: '{p}', set: 'FracturedOrigins',
 skill: [{name: 'Terraform', cost: '{p}', effect: {class: 'Terraform'}},
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsHaven', name: "Dragon's Haven", rarity: 'Rare', image: 'Cards/fow/DragonsHaven.png', flavor: '', 
 category: 'Terrain', color: 'White', type: 'Dragon', trait: 'Light', hp: 13, cost: '{w}{w}', essence: '{w}', set: 'FracturedOrigins',
  skill: [{name: 'Terraform', cost: '{1}{w}', effect: {class: 'Terraform'}},
  {name: 'Awaken', cost: '{1}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsMoonhold', name: "Dragon's Moonhold", rarity: 'Rare', image: 'Cards/fob/DragonsMoonhold.png', flavor: '', 
 category: 'Terrain', color: 'Black', type: 'Dragon', trait: 'Dark', hp: 13, cost: '{b}', essence: '{b}', set: 'FracturedOrigins',
 skill: [{name: 'Terraform', cost: '{b}', effect: {class: 'Terraform'}},
  {name: 'Awaken', cost: '{b}{b}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
  {name: 'Dragon Echo', cost: '{u}',
   activation: {'Echo', archetype: 'Dragon'},
...
{id: 'HardenedScales', name: 'Hardened Scales', rarity: 'Common', image: 'Cards/fog/HardenedScales.png', flavor: '', 
 ...
 category: 'Creature', color: 'White', type: 'Beast', trait: '', hp: 6, atk: 2, def: 1,
 cost: '{2}{W}', ability: 'Flying', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{2}{w}', effect: {class: 'Summon'}}]},
...
const FILTERS = {
  ...
  type: { key: 'type', label: 'Type', options: ['All','Beast','Brute','Construct','Dark','Demon','Dragon','Dwarf','Elemental','Elf',
	'Fire','Faefolk','Fairy','Goblin','Human','Light','Orc','Satyr','Shadow','Spirit','Toxic','Water','Undead'] },
  rarity: { key: 'rarity', label: 'Rarity', options: ['All','Common','Rare','Legend'] },
  trait: { key: 'trait', label: 'Trait', options: ['All','Assembly','Dominion','Evolution','Fusion','Warrior','Mage','Ranger','Relic','Equipment','Aura','Enchantment','Terrain','Locale'] },
