...
{ id: 'basicfirepixie', name: 'Fire Pixie', rarity: 'Common', image: 'CardImages/BasicCreatures/Fire Pixie.png', category: 'creature', color: 'red', type: 'fairy', hp: 3, atk: 2, def: 0, cost: { red: 2 }, archetype: 'Firelands', ability: ['burn','flying'], set: 'StandardPack'},
...
{ id: 'basicwolfgray', name: 'Desert Wolf', rarity: 'Rare', image: 'CardImages/BasicCreatures/Desert Wolf.png', category: 'creature', color: 'gray', type: 'beast', hp: 3, atk: 2, def: 0, cost: { red: 2 }, archetype: 'Scorchlands', ability: 'burn', set: 'StandardPack'},
