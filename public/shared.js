...
{id: 'WildhornSongreaver', name: 'Wildhorn Songreaver', rarity: 'Rare', image: 'Cards/egg/WildhornSongreaver.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', hp: 6, atk: 2, def: 0,
...
{id: 'EarthrootTitan', name: 'Earthroot Titan', rarity: 'Rare', image: 'Cards/egg/EarthrootTitan.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Beast', archetype: '', trait: 'Giant', hp: 9, atk: 5, def: 1,
...
{id: 'ElementalofLeaves', name: 'Elemental of Leaves', rarity: 'Common', image: 'Cards/egg/ElementalofLeaves.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elemental', archetype: '', trait: 'Arbor', hp: 5, atk: 1, def: 0, cost: '{g}', 
...
{id: 'Satyr', name: 'Satyr', rarity: 'Common', image: 'Cards/egg/Satyr.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', hp: 5, atk: 2, def: 0,
...
{id: 'KaelenBlazebornHuntress', name: 'Kaelen, Blazeborn Huntress', rarity: 'Legend', image: 'Cards/egr/KaelenBlazebornHuntress.png', flavor: '', 
 ...
 cost: '{1}{r}', ability: 'Burn', set: 'ElementaGenesis',
...
{id: 'CinderpeakTyrant', name: 'Cinderpeak Tyrant', rarity: 'Rare', image: 'Cards/egr/CinderpeakTyrant.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Orc', archetype: '', trait: 'Giant', hp: 9, atk: 5, def: 0,
...
{id: 'MoltenExpanse', name: 'Molten Expanse', rarity: 'Rare', image: 'Cards/egr/MoltenExpanse.png', flavor: '', 
 category: 'Terrain', color: 'Red', type: '', trait: 'Fire', hp: 7, cost: '{r}', essence: '{R}', set: 'ElementaGenesis',
...
{id: 'Volcano', name: 'Volcano', rarity: 'Common', image: 'Cards/egr/Volcano.png', flavor: '', 
 category: 'Terrain', color: 'Red', type: '', hp: 5, cost: '{1}', essence: '{R}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{0}', effect: {class: 'Terraform'}}]},

{id: 'FlameBlast', name: 'Flame Blast', rarity: 'Common', image: 'Cards/egr/FlameBlast.png', flavor: '', 
 category: 'Spell', color: 'Red', type: '', trait: 'Fire', cost: '{r}', set: 'ElementaGenesis',
...
{id: 'WavecrashWhale', name: 'Wavecrash Whale', rarity: 'Rare', image: 'Cards/egu/WavecrashWhale.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', archetype: 'Marine', trait: 'Oceanic', hp: 12, atk: 5, def: 0,
...
{id: 'Mermaid', name: 'Mermaid', rarity: 'Common', image: 'Cards/egu/Mermaid.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Merfolk', archetype: '', trait: '', hp: 4, atk: 1, def: 0,
...
{id: 'Dolphin', name: 'Dolphin', rarity: 'Common', image: 'Cards/egu/Dolphin.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', archetype: '', trait: '', hp: 5, atk: 1, def: 0,
...
{id: 'RuneboundShark', name: 'Runebound Shark', rarity: 'Common', image: 'Cards/egu/RuneboundShark.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Marine', archetype: '', trait: '', hp: 4, atk: 3, def: 0,
 cost: '{1}{u}', ability: 'Dive', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{1}{u}', effect: {class: 'Summon'}},
	{name: 'Frenzy', activation: {class:'Frenzy'}, effect: {class: 'Frenzy'}},
...
{id: 'EssenceInsight', name: 'Essence Insight', rarity: 'Common', image: 'Cards/egu/EssenceInsight.png', flavor: '', 
 category: 'Spell', color: 'Blue', type: '', cost: '{1}', set: 'ElementaGenesis',
...
{id: 'ZyraThunderbladeDuelist', name: 'Zyra, Thunderblade Duelist', rarity: 'Legend', image: 'Cards/egy/ZyraThunderbladeDuelist.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Human', archetype: '', trait: 'Warrior', hp: 5, atk: 2, def: 1,
...
{id: 'GalestrikeRoc', name: 'Galestrike Roc', rarity: 'Rare', image: 'Cards/egy/GalestrikeRoc.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Avian', archetype: '', trait: '', hp: 5, atk: 3, def: 0,
...
{id: 'SuncrestFalcon', name: 'Suncrest Falcon', rarity: 'Common', image: 'Cards/egy/SuncrestFalcon.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Avian', archetype: '', hp: 2, atk: 2, def: 0, 
...
{id: 'GravokDrakzulTyrant', name: 'Gravok, Drakzul Tyrant', rarity: 'Legend', image: 'Cards/egc/GravokDrakzulTyrant.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Orc', archetype: '', trait: 'Warrior', hp: 5, atk: 2, def: 2,
...
{id: 'RockmaulRhino', name: 'Rockmaul Rhino', rarity: 'Rare', image: 'Cards/egc/RockmaulRhino.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Beast', archetype: '', trait: 'Brute', hp: 7, atk: 4, def: 2,
...
{id: 'ElementalofBoulders', name: 'Elemental of Boulders', rarity: 'Rare', image: 'Cards/egc/ElementalofBoulders.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Elemental', archetype: '', trait: 'Golem', hp: 4, atk: 4, def: 3,
...
{id: 'SlatebackLizard', name: 'Slateback Lizard', rarity: 'Rare', image: 'Cards/egc/SlatebackLizard.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Reptile', archetype: '', trait: '', hp: 5, atk: 4, def: 1,
...
{id: 'Golemites', name: 'Golemites', rarity: 'Common', image: 'Cards/egc/Golemite.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Elemental', archetype: '', trait: 'Golem', hp: 1, atk: 1, def: 2,
 cost: '{0}', ability: 'Unbreakable', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'Orc', name: 'Orc', rarity: 'Common', image: 'Cards/egc/Orc.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Orc', archetype: '', trait: 'Warrior', hp: 4, atk: 3, def: 1,
...
{id: 'BarrensTrampler', name: 'Barrens Trampler', rarity: 'Common', image: 'Cards/egc/BarrensTrampler.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Beast', archetype: '', trait: '', hp: 10, atk: 2, def: 0,
 cost: '{2}{c}', ability: 'Crush', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{2}{c}', effect: {class: 'Summon'}}]},
...
{id: 'ElementalofPebbles', name: 'Elemental of Pebbles', rarity: 'Common', image: 'Cards/egc/ElementalofPebbles.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Elemental', archetype: '', trait: 'Golem', hp: 2, atk: 2, def: 2,
...
{id: 'FesterglowFrontier', name: 'Festerglow Frontier', rarity: 'Rare', image: 'Cards/egp/FesterglowFrontier.png', flavor: '', 
 category: 'Terrain', color: 'Purple', type: '', trait: 'Toxic', hp: 6, cost: '{p}', essence: '{p}', set: 'ElementaGenesis',
...
{id: 'GiantHornet', name: 'Giant Hornet', rarity: 'Common', image: 'Cards/egp/GiantHornet.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Bug', archetype: '', trait: 'Toxic', hp: 3, atk: 2, def: 0,
...
{id: 'FenGoblin', name: 'Fen Goblin', rarity: 'Common', image: 'Cards/egp/FenGoblin.png', flavor: '', 
 category: 'Creature', color: 'Purple', type: 'Goblin', archetype: '', trait: '', hp: 2, atk: 1, def: 0,
 cost: '{0}', ability: ['Pilfer','Venom'], set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},
         
{id: 'Swamp', name: 'Swamp', rarity: 'Common', image: 'Cards/egp/Swamp.png', flavor: '', 
 category: 'Terrain', color: 'Purple', type: '', hp: 5, cost: '{1}', essence: '{p}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{0}', effect: {class: 'Terraform'}}]},

{id: 'SporeCloud', name: 'Spore Cloud', rarity: 'Common', image: 'Cards/egp/SporeCloud.png', flavor: '', 
 category: 'Spell', color: 'Purple', type: '', trait: 'Toxic', cost: '{1}{p}', set: 'ElementaGenesis',
...
{id: 'EssenceBreak', name: 'Essence Break', rarity: 'Common', image: 'Cards/egp/EssenceBreak.png', flavor: '', 
 category: 'Spell', color: 'Purple', type: '', cost: '{3}', set: 'ElementaGenesis',
...
{id: 'Solmara', name: 'Solmara', rarity: 'Legend', image: 'Cards/egw/Solmara.png', flavor: '', 
 category: 'Terrain', color: 'White', type: '', hp: 20, cost: '{0}', essence: '{W}', trait: 'Dominion', set: 'ElementaGenesis',
...
{id: 'RadiantJudgement', name: 'Radiant Judgement', rarity: 'Legend', image: 'Cards/egw/RadiantJudgement.png', flavor: '', 
 category: 'Spell', color: 'White', type: '', cost: '{3}', set: 'ElementaGenesis',
...
{id: 'SolmaraArchpriest', name: 'Solmara Archpriest', rarity: 'Rare', image: 'Cards/egw/SolmaraArchpriest.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Human', archetype: '', trait: 'Mage', hp: 5, atk: 2, def: 0,
...
{id: 'Pegasus', name: 'Pegasus', rarity: 'Rare', image: 'Cards/egw/Pegasus.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Beast', archetype: '', trait: 'Mythic', hp: 6, atk: 3, def: 0,
...
{id: 'SkylionExemplar', name: 'Skylion Exemplar', rarity: 'Rare', image: 'Cards/egw/SkylionExemplar.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Beast', archetype: '', trait: '', hp: 8, atk: 4, def: 0,
...
{id: 'Angel', name: 'Angel', rarity: 'Common', image: 'Cards/egw/Angel.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Angel', archetype: '', trait: '', hp: 5, atk: 1, def: 0,
...
{id: 'DawlightLady', name: 'Dawlight Lady', rarity: 'Common', image: 'Cards/egw/DawlightLady.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Human', archetype: '', trait: '', hp: 4, atk: 1, def: 0,
...
{id: 'DawnbladeSeraph', name: 'Dawnblade Seraph', rarity: 'Common', image: 'Cards/egw/DawnbladeSeraph.png', flavor: '', 
 category: 'Creature', color:'White', type: 'Angel', archetype: '', trait:  'Warrior', hp: 4, atk: 2, def: 1,
...
{id: 'Valkyrie', name: 'Valkyrie', rarity: 'Common', image: 'Cards/egw/Valkyrie.png', flavor: '', 
 category: 'Creature', color: 'White', type: '', archetype: '', trait: 'Warrior', hp: 5, atk: 2, def: 1,
...
{id: 'ShiningPigeon', name: 'Shining Pigeon', rarity: 'Common', image: 'Cards/egw/ShiningPigeon.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Avian', archetype: '', trait: '', hp: 2, atk: 1, def: 0,
 cost: '{0}', ability: 'Flying', set: 'ElementaGenesis',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'WhitegroveHuntress', name: 'Whitegrove Huntress', rarity: 'Common', image: 'Cards/egw/WhitegroveHuntress.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Elf', archetype: '', trait: 'Ranger', hp: 3, atk: 2, def: 0,
...
{id: 'Plains', name: 'Plains', rarity: 'Common', image: 'Cards/egw/Plains.png', flavor: '', 
 category: 'Terrain', color: 'White', type: '', hp: 5, cost: '{1}', essence: '{w}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{0}', effect: {class: 'Terraform'}}]},
...
{id: 'EssenceBlessing', name: 'Essence Blessing', rarity: 'Common', image: 'Cards/egw/EssenceBlessing.png', flavor: '', 
 category: 'Spell', color: 'White', type: '', cost: '{1}', set: 'ElementaGenesis',
 skill: [{name: 'Cast', cost: '{1}', effect: {class: 'Cast'}}]},
...
{id: 'Nocthyra', name: 'Nocthyra', rarity: 'Legend', image: 'Cards/egb/Nocthyra.png', flavor: '', 
 category: 'Terrain', color: 'Black', type: '', hp: 20, cost: '{0}', essence: '{B}', trait: 'Dominion', set: 'ElementaGenesis',
...
{id: 'UmbralNova', name: 'Umbral Nova', rarity: 'Legend', image: 'Cards/egb/UmbralNova.png', flavor: '', 
 category: 'Spell', color: 'Black', type: '', trait: 'Dark', cost: '{3}{b}', set: 'ElementaGenesis',
...
{id: 'NoctyraEnforcer', name: 'Noctyra Enforcer', rarity: 'Rare', image: 'Cards/egb/NoctyraEnforcer.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Human', archetype: '', trait: 'Warrior', hp: 4, atk: 3, def: 1,
...
{id: 'UmbrawindHollow', name: 'Umbrawind Hollow', rarity: 'Rare', image: 'Cards/egb/UmbrawindHollow.png', flavor: '', 
 category: 'Terrain', color: 'Black', type: '', trait: 'Dark', hp: 8, cost: '{1}{b}', essence: '{B}', set: 'ElementaGenesis',
...
{id: 'Mindbreak', name: 'Mindbreak', rarity: 'Rare', image: 'Cards/egb/Mindbreak.png', flavor: '', 
 category: 'Spell', color: 'Black', type: '', trait: 'Dark', cost: '{1}{b}', set: 'ElementaGenesis',
...
{id: 'Bat', name: 'Bat', rarity: 'Common', image: 'Cards/egb/Bat.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Beast', archetype: 'Vampiric', hp: 3, atk: 1, def: 0,
...
{id: 'Shadowland', name: 'Shadowland', rarity: 'Common', image: 'Cards/egb/Shadowland.png', flavor: '', 
 category: 'Terrain', color: 'Black', type: '', hp: 5, cost: '{1}', essence: '{b}', set: 'ElementaGenesis',
 skill: [{name: 'Terraform', cost: '{0}', effect: {class: 'Terraform'}}]},
...
{id: 'SylvaniaThornvaleQueen', name: 'Sylvania, Thornvale Queen', rarity: 'Legend', image: 'Cards/Elf/SylvaniaThornvaleQueen.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Elf', archetype: '', trait: 'Mage', hp: 4, atk: 1, def: 0,
...
{id: 'KaelyraFirelandHeiress', name: 'Kaelyra, Fireland Heiress', rarity: 'Legend', image: 'Cards/Fireland/KaelyraFirelandHeiress.png', flavor: '', imageFullArt: 'Cards/Fireland/KaelyraFirelandHeiressFA.png', flavor: '',
 category: 'Creature', color: ['Red','Black'], type: 'Human', archetype: 'Fireland', trait: 'Mage', hp: 4, atk: 1, def: 0,
...
{id: 'VorgannaCrimsonBlade', name: 'Vorganna, Crimson Blade', rarity: 'Legend', image: 'Cards/Fireland/VorgannaCrimsonBlade.png', flavor: '', 
 category: 'Creature', color: ['Black','Red'], type: 'Human', archetype: '', trait: 'Warrior', hp: 4, atk: 3, def: 1,
...
{id: 'TydrosCoralboundTidebreaker', name: 'Tydros, Coralbound Tidebreaker', rarity: 'Legend', image: 'Cards/Coralbound/TydrosCoralboundTidebreaker.png', flavor: '', 
 category: 'Creature', color: ['Blue','Gray'], type: 'Merfolk', archetype: 'Coralbound', trait: 'Warrior', hp: 6, atk: 2, def: 0,
 cost: '{2}{u}', ability: 'Dive', set: 'IronbornProtocol',
 skill: [{name: 'Summon', cost: '{u}', effect: {class: 'Summon'}},
...
{id: 'AstranyraThunderbane', name: 'Astranyra, Thunderbane', rarity: 'Legend', image: 'Cards/Demon/AstranyraThunderbane.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Human', archetype: '', trait: 'Warrior', hp: 3, atk: 2, def: 1,
...
{id: 'VeniryssSpiderPrincess', name: 'Veniryss, Spider Princess', rarity: 'Legend', image: 'Cards/ecp/VeniryssSpiderPrincess.png', flavor: '', 
 category: 'Creature', color: ['Purple','Green'], type: 'Elf', archetype: 'Silkbound', trait: 'Mage', hp: 8, atk: 1, def: 0,
...
{id: 'AethercruxParagon', name: 'Aethercrux Paragon', rarity: 'Legend', image: 'Cards/ecw/AethercruxParagon.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Construct', archetype: 'Lightforge', trait: 'Light', hp: 9, atk: 2, def: 1,
 cost: '{w}{w}', ability: ['Protect'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{w}', effect: {class: 'Summon'}},
  {name:'Dash', cost: '{w}',
...
{id: 'NyzarielArchdemonDuchess', name: 'Nyzariel, Archdemon Duchess', rarity: 'Legend', image: 'Cards/fob/NyzarielArchdemonDuchess.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Demon', archetype: 'Archdemon', trait: 'Mage', hp: 4, atk: 2, def: 0,
...
{id: 'Imp', name: 'Imp', rarity: 'Common', image: 'Cards/egb/Imp.png', flavor: '', 
 category: 'Creature', color: 'Black', type: 'Demon', archetype: '', hp: 3, atk: 2, def: 0,
...
{id: 'ForestWarrior', name: 'Forest Warrior', rarity: 'Rare', image: 'Cards/Arbor/ForestWarrior.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Construct', archetype: '', trait: 'Warrior', hp: 6, atk: 3, def: 1, cost: '{1}{G}', 
...
{id: 'ElarisGroveLeafcaller', name: 'Elaris, Grove Leafcaller', rarity: 'Legend', image: 'Cards/Arbor/ElarisGroveLeafcaller.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Satyr', archetype: '', trait: 'Mage', hp: 5, atk: 1, def: 0, cost: '{1}{G}', 
 ability: '', set: 'EchoesofCreation',
 skill: [
  {name: 'Arrival',
   activation: {class: 'Arrival'},
...
{id: 'ZephyraHarpy', name: 'Zephyra Harpy', rarity: 'Rare', image: 'Cards/ecy/ZephyraHarpy.png', flavor: '', 
 category: 'Creature', color: 'Yellow', type: 'Avian', archetype: 'Zephyra', hp: 4, atk: 2, def: 0,
...
{id: 'AnvilguardDwarf', name: 'Anvilguard Dwarf', rarity: 'Common', image: 'Cards/foc/AnvilguardDwarf.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Dwarf', archetype: '', trait: 'Warrior', hp: 4, atk: 2, def: 1,
...
{id: 'DrakzulWarmonger', name: 'Drakzul Warmonger', rarity: 'Rare', image: 'Cards/egc/DrakzulWarmonger.png', flavor: '', 
 category: 'Creature', color: 'Gray', type: 'Human', archetype: '', trait: 'Warrior', hp: 6, atk: 3, def: 1,
...
{id: 'TreantWitch', name: 'Treant Witch', rarity: 'Rare', image: 'Cards/Arbor/TreantWitch.png', flavor: '', 
 category: 'Creature', color: ['Green','Black'], type: 'Elemental', archetype: 'Arbor', trait: 'Mage', hp: 6, atk: 1, def: 1, cost: '{1}{g}', 
...
{id: 'HeraldofLight', name: 'Herald of Light', rarity: 'Rare', image: 'Cards/BasicCreatures/HeraldofLight.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Construct', archetype: 'Seraph', hp: 4, atk: 2, def: 1,
...
{id: 'SacredKirin', name: 'Sacred Kirin', rarity: 'Rare', image: 'Cards/Hybrid/SacredKirin.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Beast', archetype: '', trait: 'Mythical', hp: 7, atk: 4, def: 1, cost: '{2}{W}', 
...
{id: 'LightPossessedArmor', name: 'Light Possessed Armor', rarity: 'Rare', image: 'Cards/Construct/LightPossessedArmor.png', flavor: '', 
 category: 'Creature', color: 'White', type: 'Construct', archetype: 'Solarforge', trait: 'Light', hp: 4, atk: 2, def: 2, cost: '{1}{W}', 
...
{id: 'DarkHarpy', name: 'Dark Harpy', rarity: 'Rare', image: 'Cards/Zephyra/DarkHarpy.png', flavor: '', 
 category: 'Creature', color: ['Yellow','Black'], type: 'Avian', archetype: 'Harpy', trait: 'Dark', hp: 5, atk: 3, def: 0,
...
{id: 'GildedBladedancer', name: 'Gilded Bladedancer', rarity: 'Common', image: 'Cards/ecg/GildedBladedancer.png', flavor: '', 
 category: 'Creature', color: 'Green', type: 'Fairy', archetype: '', type: 'Warrior', hp: 4, atk: 2, def: 1, cost: '{g}', 
...
{id: 'DreadbloomFaerie', name: 'Dreadbloom Faerie', rarity: 'Rare', image: 'Cards/Fairy/DreadbloomFaerie.png', flavor: '', 
 category: 'Creature', color: ['Green','Purple'], type: 'Fairy', archetype: '', trait: 'Cursed', hp: 3, atk: 1, def: 0, cost: '{p}', 
 ability: ['Flying','Rush'], set: 'ElementaGenesis',
 skill: [
  {name: 'Dash', cost: '{G}',
  effect: {class: 'Dash'}}
...
{id: 'FirelandDirebeast', name: 'Fireland Direbeast', rarity: 'Rare', image: 'Cards/Beast/FirelandDirebeast.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Beast', archetype: 'Fireland', trait: 'Fire', hp: 6, atk: 3, def: 0,
...
{id: 'EphorosFirelandBehemoth', name: 'Ephoros, Fireland Behemoth', rarity: 'Legend', image: 'Cards/Beast/EphorosFirelandBehemoth.png', flavor: '', imageFullArt: 'Cards/Fireland/EphorosFirelandBehemothFA.png', flavor: '',
 category: 'Creature', color: ['Red','Black'], type: ['Beast','Demon'], archetype: 'Fireland', trait: 'Fire', hp: 9, atk: 5, def: 0,
 cost: '{5}{r}', ability: ['Burn','Crush'], set: 'SavageTerritory',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
...
{id: 'PyrokragGolemheartTitan', name: 'Pyrokrag, Golemheart Titan', rarity: 'Legend', image: 'Cards/for/PyrokragGolemheartTitan.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', archetype: 'Golem', trait: 'Fire', hp: 5, atk: 5, def: 2,
 cost: '{5}{r}', ability: 'Scorch', trait: 'Fusion', set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
...
{id: 'GolemheartGiant', name: 'Golemheart Giant', rarity: 'Rare', image: 'Cards/for/GolemheartGiant.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', archetype: 'Golem', trait: 'Fire', hp: 5, atk: 4, def: 2,
...
{id: 'GolemheartSentinel', name: 'Golemheart Sentinel', rarity: 'Rare', image: 'Cards/for/GolemheartSentinel.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', trait: 'Fire', hp: 4, atk: 3, def: 2,
 cost: '{2}{r}', archetype: 'Golemheart', ability: 'Protect', set: 'PrimordialAscension'},

{id: 'FireGolem', name: 'Fire Golem', rarity: 'Common', image: 'Cards/Golem/FireGolem.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: ['Elemental','Golem'], hp: 3, atk: 1, def: 2,
 cost: '{1}{r}', archetype: 'Golemheart', ability: ['Burn', 'Scorch'], set: 'PrimordialAscension',
 skill: [{name: 'Summon', cost: '{1}{r}', effect: {class: 'Summon'}},
  {name: 'Discard', cost: '{c}', 
   requirement: {class: 'Discard'},
...
{id: 'KaelgorranElementalPrimordial', name: 'Kaelgorran, Elemental Primordial', rarity: 'Legend', image: 'Cards/foc/KaelgorranElementalPrimordial.png', flavor: '', imageFullArt: 'Cards/Golems/KaelgorranElementalPrimordialFA.png', flavor: '',
 category: 'Creature', color: ['Green','Red', 'Gray'], type: 'Elemental', archetype: 'Golem', hp: 7, atk: 4, def: 2, cost: '{5}{c}',
 ability: '', trait: 'Fusion', set: 'PrimordialAscension',
...
{id: 'AcidicGolem', name: 'Acidic Golem', rarity: 'Rare', image: 'Cards/Elemental/AcidicGolem.png', flavor: '', 
 category: 'Creature', color: ['Purple', 'Gray'], type: 'Elemental', trait: 'Golem', hp: 5, atk: 3, def: 2,
...
{id: 'CinderScout', name: 'Cinder Scout', rarity: 'Common', image: 'Cards/ecr/CinderScout.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', archetype: 'Cindercore', trait: 'Fire', hp: 1, armor: 1, atk: 1, def: 0,
 cost: '{0}', ability: ['Armor','Exploit'], set: 'IronbornProtocol',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
  {name: 'Discard', cost: '{R}', 
   requirement: {class: 'Discard'},
...
{id: 'CindercoreSentry', name: 'Cindercore Sentry', rarity: 'Common', image: 'Cards/ecr/CindercoreSentry.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', archetype: 'Cindercore', trait: 'Fire', hp: 2, armor: 3, atk: 2, def: 0,
 cost: '{r}', ability: ['Armor','Fire Exploit'], set: 'IronbornProtocol',
 skill: [{name: 'Summon', cost: '{r}', effect: {class: 'Summon'}},
...
{id: 'CindercoreProtector', name: 'Cindercore Protector', rarity: 'Rare', image: 'Cards/ecr/CindercoreProtector.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', archetype: 'Cindercore', trait: 'Fire', hp: 4, atk: 3, def: 0,
...
{id: 'CindercoreVanguard', name: 'Cindercore Vanguard', rarity: 'Common', image: 'Cards/ecr/CindercoreVanguard.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', archetype: 'Cindercore', trait: 'Fire', hp: 3, atk: 3, def: 0,
...
{id: 'CinderGolem', name: 'Cinder Golem', rarity: 'Rare', image: 'Cards/Construct/CinderGolem.png', flavor: '', 
 category: 'Creature', color: ['Red', 'Gray'], type: 'Elemental', archetype: 'Golemheart', trait: 'Fire', hp: 15, atk: 6, def: 3,
...
{id: 'IgnavarynCindercoreAutomaton', name: 'Ignavaryn, Cindercore Automaton', rarity: 'Legend', image: 'Cards/ecr/IgnavarynCindercoreAutomaton.png', flavor: '', 
 category: 'Creature', color: 'Red', type: 'Construct', archetype: 'Cindercore', trait: 'Fire', hp: 5, armor: 10, atk: 4, def: 3,
 cost: '{5}{r}', ability: ['Armor','Exploit','Protect'], set: 'IronbornProtocol',
...
{id: 'CoralDrone', name: 'Coral Drone', rarity: 'Common', image: 'Cards/Construct/CoralDrone.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Construct', archetype: 'Coralbound', trait: 'Water', hp: 1, armor: 1, atk: 1, def: 1,
...
{id: 'CoralboundSentry', name: 'Coralbound Sentry', rarity: 'Common', image: 'Cards/Construct/CoralboundSentry.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Construct', archetype: 'Coralbound', trait: 'Water', hp: 4, armor: 1, atk: 1, def: 1,
...
{id: 'CoralboundProtector', name: 'Coralbound Protector', rarity: 'Rare', image: 'Cards/Construct/CoralboundProtector.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Construct', archetype: 'Coralbound', trait: 'Water', hp: 4, armor: 3, atk: 3, def: 2,
...
{id: 'CoralboundVanguard', name: 'Coralbound Vanguard', rarity: 'Rare', image: 'Cards/Construct/CoralboundVanguard.png', flavor: '', 
 category: 'Creature', color: 'Blue', type: 'Construct', archetype: 'Coralbound', trait: 'Water', hp: 3, armor: 2, atk: 3, def: 1,
...
{id: 'MaelvyrnCoralboundAutomaton', name: 'Maelvyrn, Coralbound Automaton', rarity: 'Legend', image: 'Cards/Construct/MaelvyrnCoralboundAutomaton.png', flavor: '', imageFullArt: 'Cards/Coralbound/MaelvyrnCoralboundAutomatonFA.png', flavor: '',
 category: 'Creature', color: 'Blue', type: 'Construct', archetype: 'Coralbound', trait: 'Water', hp: 6, atk: 5, armor: 5, def: 4, cost: '{6}{u}',
...
{id: 'HydrosurgeProtocol', name: 'Hydrosurge Protocol', rarity: 'Common', image: 'Cards/Construct/HydrosurgeProtocol.png', flavor: '', 
 category: 'Spell', color: 'Blue', type: 'Construct', cost: '{1}{U}', archetype: 'Coralbound', trait: 'Water', set: 'IronbornProtocol',
...
{id: 'HydrionPrimevalFloodbringer', name: 'Hydrion, Primeval Floodbringer', rarity: 'Legend', image: 'Cards/fou/HydrionPrimevalFloodbringer.png', flavor: '', imageFullArt: 'Cards/Coralbound/MaelvyrnCoralboundAutomatonFA.png', flavor: '',
 category: 'Creature', color: 'Blue', type: 'Elemental', archetype: 'Hydral', trait: 'Fusion', hp: 10, atk: 0, def: 0, cost: '{5}{u}',
...
{id: 'WyrmofThornsandSunfire', name: 'Wyrm of Thorns and Sunfire', rarity: 'Rare', image: 'Cards/Dragon/Wyrm of Thorns and Sunfire.png', flavor: '', 
 category: 'Creature', color: ['Green', 'Red', 'White'], type: 'Dragon', archetype: '', hp: 5, atk: 3, def: 1,
...
{id: 'FairyDragon', name: 'Fairy Dragon', rarity: 'Rare', image: 'Cards/Dragon/FairyDragon.png', flavor: '', 
 ...
 ability: 'Flying', archetype: ['Fairy', 'Glimmerscale'], set: 'MischiefUnbound',
 skill: [
  {name: 'Purify', cost: '{W}',
   requirement: {class: 'CW'},
   effect: {class: 'Purify'}},
...
{id: 'FairyAmphitere', name: 'Fairy Amphitere', rarity: 'Rare', image: 'Cards/Dragon/FairyAmphitere.png', flavor: '', 
 category: 'Creature', color: ['Green', 'Red', 'White'], type: 'Dragon', archetype: ['Fairy', 'Glimmerscale'], hp: 8, atk: 4, def: 1,
...
//--- GOBLIN CARDS ---//
{id: 'GoblinWarlod', name: 'Goblin Warlod', rarity: 'Legend', image: 'Cards/Brute/GoblinWarlod.png', flavor: '', 
 category: 'Creature', color: ['Green', 'Purple', 'Black'], type: 'Goblin', archetype: '', trait: 'Mage', hp: 6, atk: 3, def: 0,
...
{id: 'SinisterWolf', name: 'Sinister Wolf', rarity: 'Common', image: 'Cards/Beast/SinisterWolf.png', flavor: '', 
 category: 'Creature', color: ['Black'], type: 'Beast', archetype: 'Moonfang', trait: 'Dark', hp: 5, atk: 3, def: 0,
...
{id: 'Werewolf', name: 'Werewolf', rarity: 'Common', image: 'Cards/Beast/Werewolf.png', flavor: '', 
 category: 'Creature', color: ['Black'], type: 'Beast', trait: 'Dark', hp: 6, atk: 3, def: 1,
 cost: '{2}{b}', archetype: 'Moonfang', ability: ['Ambush'], set: 'EchoesofCreation',
 skill: [
  {name: 'Discard', cost: '{B}',
  requirement: {class: 'Discard'},
...
{id: 'SkullframeAcolyte', name: 'Skullframe Acolyte', rarity: 'Common', image: 'Cards/Undead/SkullframeAcolyte.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: 'Undead', archetype: 'Skullframe', trait: 'Mage', hp: 4, atk: 3, def: 0,
...
{id: 'Cryptwinds', name: 'Cryptwinds', rarity: 'Common', image: 'Cards/Undead/Cryptwinds.png', flavor: '', 
 category: 'Creature', color: 'Black', type: ['Dragon','Undead'], archetype: 'Skullframe', hp: 4, atk: 2, def: 1,
...
{id: 'XulZulSkullframeEternal', name: "Xul'Zul, Skullframe Eternal", rarity: 'Legend', image: 'Cards/fop/XulZulSkullframeEternal.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: ['Dragon','Undead'], archetype: 'Skullframe', hp: 8, atk: 5, def: 1,
...
{id: 'SkullframeArmoredDragon', name: 'Skullframe Armored Dragon', rarity: 'Rare', image: 'Cards/Undead/SkullframeArmoredDragon.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: ['Dragon','Undead'], archetype: 'Skullframe', hp: 5, armor: 4, atk: 4, def: 2,
...
{id: 'SkullframeHexmistress', name: 'Skullframe Hexmistress', rarity: 'Rare', image: 'Cards/Undead/SkullframeHexmistress.png', flavor: '', 
 category: 'Creature', color: ['Black', 'Purple'], type: 'Undead', archetype: 'Skullframe', trait: 'Mage', hp: 3, atk: 2, def: 0,
 cost: '{1}{b}', ability: 'Immunity', set: 'FracturedOrigins',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}},
...
{id: 'MaldryssSkullframeArchmage', name: 'Maldryss, Skullframe Archmage', rarity: 'Legend', image: 'Cards/Undead/MaldryssSkullframeArchmage.png', flavor: '', imageFullArt: 'Cards/Skullframe/MaldryssSkullframeArchmageFA.png', flavor: '',
...
{id: 'Soulhexing', name: 'Soulhexing', rarity: 'Common', image: 'Cards/Undead/Soulhexing.png', flavor: '', 
 category: 'Spell', color: 'Black', type: 'Undead', cost: '{2}{B}', archetype: 'Skullframe', effect: 'Destroy a creature afflicted by any status', set: 'ElementaGenesis'},
...
{id: 'FrostlandDragon', name: 'Frostland Dragon', rarity: 'Rare', image: 'Cards/Frostland/FrostlandDragon.png', flavor: '', 
 ...
 cost: '{3}{U}{C}', archetype: 'Frostland', ability: ['Ice Armor','Flying'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'FrostlandWyrm', name: 'Frostland Wyrm', rarity: 'Common', image: 'Cards/Frostland/FrostlandWyrm.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Dragon', trait: 'Ice', hp: 4, atk: 2, def: 2,
 cost: '{1}{U}{C}', archetype: 'Frostland', ability: ['Ice Armor','Flying'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'FrostlandGolem', name: 'Frostland Golem', rarity: 'Common', image: 'Cards/Frostland/FrostlandGolem.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Elemental', archetype: 'Frostland', trait: 'Ice', hp: 5, atk: 3, def: 3,
 cost: '{1}{U}{C}', ability: 'Ice Armor', set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'FrostlandPhoenix', name: 'Frostland Phoenix', rarity: 'Common', image: 'Cards/Frostland/FrostlandPhoenix.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Avian', archetype: 'Frostland', trait: 'Ice', hp: 3, atk: 1, def: 1,
...
{id: 'FrostlandRuneforgedAutomaton', name: 'Frostland Runeforged Automaton', rarity: 'Rare', image: 'Cards/Frostland/FrostlandRuneforgedAutomaton.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Construct', archetype: 'Frostland', trait: 'Ice', hp: 9, atk: 5, def: 2,
 cost: '{2}{U}{C}', ability: ['Crush','Exploit'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'KryxalonFrostRuneforgedColossus', name: 'Kryxalon, Frost Runeforged Colossus', rarity: 'Legend', image: 'Cards/Frostland/KryxalonFrostRuneforgedColossus.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Construct', archetype: 'Frostland', hp: 11, atk: 5, def: 3,
 cost: '{4}{U}{C}', ability: ['Crush', 'Exploit'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},

{id: 'EirawenFrostlandQueenFA', name: 'Eirawen, Frostland Queen', rarity: 'Legend', image: 'Cards/Frostland/EirawenFrostlandQueen.png', flavor: '', 
 category: 'Creature', color: ['Blue', 'Gray'], type: 'Elf', archetype: 'Frostland', trait: 'Mage', hp: 6, atk: 1, def: 0,
 cost: '{U}{U}{C}', ability: ['Ice Armor','Flying'], set: 'EchoesofCreation',
 skill: [{name: 'Summon', cost: '{0}', effect: {class: 'Summon'}}]},
...
{id: 'DragonsGrove', name: "Dragon's Grove", rarity: 'Rare', image: 'Cards/fog/DragonsGrove.png', flavor: '', 
 category: 'Terrain', color: 'Green', type: 'Dragon', archetype: 'Thornwing', trait: 'Nature', hp: 13, cost: '{g}{g}', essence: '{g}{g}', set: 'FracturedOrigins',
 skill: [
...
{id: 'DragonsSpire', name: "Dragon's Spire", rarity: 'Rare', image: 'Cards/for/DragonsSpire.png', flavor: '', 
 category: 'Terrain', color: 'Red', type: 'Dragon', archetype: 'Blazingscale', trait: 'Fire', hp: 11, cost: '{r}{r}', essence: '{r}{R}', set: 'FracturedOrigins',
 skill: [
  {name: 'Dragon Summon', 
...
{id: 'DragonsAtoll', name: "Dragon's Atoll", rarity: 'Rare', image: 'Cards/fou/DragonsAtoll.png', flavor: '', 
 category: 'Terrain', color: 'Blue', type: ['Terrain', 'Dragon'], archetype: 'Abyssdrake', trait: 'Water', hp: 16, cost: '{u}{u}', essence: '{u}{u}', set: 'FracturedOrigins',
  skill: [
...
{id: 'DragonsSkyreach', name: "Dragon's Skyreach", rarity: 'Rare', image: 'Cards/Dragon/DragonsSkyreach.png', flavor: '', 
 category: 'Terrain', color: 'Yellow', type: 'Dragon', archetype: 'Stormrazor', trait: 'Thunder', hp: 11, cost: '{y}{y}', essence: '{Y}', set: 'FracturedOrigins',
 skill: [
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsBastion', name: "Dragon's Bastion", rarity: 'Rare', image: 'Cards/foc/DragonsBastion.png', flavor: '', 
 category: 'Terrain', color: 'Gray', type: 'Dragon', archetype: 'Ironclaw', trait: 'Steel', hp: 12, cost: '{c}{c}', essence: '{C}', set: 'FracturedOrigins',
 skill: [
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsHollow', name: "Dragon's Hollow", rarity: 'Rare', image: 'Cards/fop/DragonsHollow.png', flavor: '', 
 category: 'Terrain', color: 'Purple', type: 'Dragon', archetype: 'Dreadspine', trait: 'Cursed', hp: 12, cost: '{0}', essence: '{P}', set: 'FracturedOrigins',
 skill: [
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsHaven', name: "Dragon's Haven", rarity: 'Rare', image: 'Cards/fow/DragonsHaven.png', flavor: '', 
 category: 'Terrain', color: 'White', type: 'Dragon', archetype: 'Solarwyrm', trait: 'Light', hp: 13, cost: '{w}{w}', essence: '{w}{w}', set: 'FracturedOrigins',
  skill: [
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'DragonsMoonhold', name: "Dragon's Moonhold", rarity: 'Rare', image: 'Cards/fob/DragonsMoonhold.png', flavor: '', 
 category: 'Terrain', color: 'Black', type: 'Dragon', archetype: 'Nightshroud', trait: 'Dark', hp: 13, cost: '{b}{b}', essence: '{b}{b}', set: 'FracturedOrigins',
 skill: [
  {name: 'Awaken', cost: '{u}{u}',
   activation: {class: 'Awaken'},
   effect: {class: 'Heal', amount: 2}},
...
{id: 'HardenedScales', name: 'Hardened Scales', rarity: 'Common', image: 'Cards/fog/HardenedScales.png', flavor: '', 
 category: 'Spell', color: ['Green','Red'], type: 'Dragon', trait: 'Aura', cost: '{1}', set: 'FracturedOrigins',
...
{id: 'MermaidsSanctuary', name: "Mermaid's Sanctuary", rarity: 'Common', image: 'Cards/egu/MermaidsSanctuary.png', flavor: '', 
 category: 'Terrain', color: 'Blue', type: 'Merfolk', hp: 11, cost: '{1}{u}', essence: '{u}', set: 'ElementaGenesis'},
...
{id: 'AngelsReach', name: "Angel's Reach", rarity: 'Common', image: 'Cards/Seraph/AngelsReach.png', flavor: '', 
 category: 'Terrain', color: 'White', type: 'Angel', hp: 5, cost: '{0}', essence: '{W}', set: 'EchoesofCreation'},
