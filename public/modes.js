...
{ id: 'Sylvan1', name: 'Verdant Might', color: 'green', difficulty: '⭐',
  image: 'Avatar/Fairy.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
{ id: 'Goblin1', name: 'Thornwine Chorus', color: ['green', 'red', 'gray', 'purple', 'black'], difficulty: '⭐',
  image: 'Avatar/Goblin.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Satyr1', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐',
  image: 'Avatar/Satyr.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'WildHuntress', amount: 4 },
      { id: 'FaunRanger', amount: 4 },
...
{ id: 'Satyr2', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐⭐',
    image: 'Images/Avatar/FaunRanger.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'FaunRanger', amount: 4 },
      { id: 'WildHuntress', amount: 4 },
...
{ id: 'Inferno1', name: 'Ember Tyranny', color: 'red', difficulty: '⭐',
  image: 'Avatar/Emberling.png', bannerArt: 'Banners/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland1', name: 'Emberfang Pride', color: 'red', difficulty: '⭐',
  image: 'Avatar/KaelenBlazebornHuntress.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Fireland4', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatar/HenchmanofEphoros.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland6', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/EphorosFirelandBehemoth.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelyraFirelandHeiress', amount: 1 },
      { id: 'EphorosFirelandBehemoth', amount: 1 },
      { id: 'HenchmanofEphoros', amount: 1 },
      { id: 'FirelandHellmaw', amount: 2 },
...
{ id: 'Tidal1', name: 'Tidebound Will', color: 'blue', difficulty: '⭐',
  image: 'Avatar/WaterElemental.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Merfolk.png',
...
{ id: 'Tempest1', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐',
    image: 'Images/Avatar/Thunderspawn.png', bannerArt: 'Images/Banner/YellowBanner.png', cardbackArt: 'Images/Cardback/Stormcore.png',
  ...
  { id: 'Terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
    image: 'Avatar/RockLizard.png', bannerArt: 'Images/Banner/GrayBanner.png', cardbackArt: 'Images/Cardback/Stonebound.png',
...
{ id: 'Cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐',
  image: 'Avatar/Goblin.png', bannerArt: 'Images/Banner/PurpleBanner.png', cardbackArt: 'Images/Cardback/Goblin.png',
...
{ id: 'Radiant1', name: 'Radiant Oath', color: 'white', difficulty: '⭐',
    image: 'Avatar/AngelicWarrior.png', bannerArt: 'Images/Banner/WhiteBanner.png', cardbackArt: 'Images/Cardback/Radiant.png',
...
{ id: 'Fairy3', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐',
  image: 'Avatar/FairyWarrior.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Arbor2', name: 'Oakhaven Awakening', color: ['green', 'black'], difficulty: '⭐⭐',
    image: 'Avatar/TreantWitch.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/CBFairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing3', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐⭐',
  image: 'Avatar/VerdantSerpent.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/VerdarokSylvanWarden.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore2', name: 'Emberforged Legion', color: 'red', difficulty: '⭐⭐',
    image: 'Avatar/CinderScout.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Cindercore3', name: 'Blazewrought Core', color: 'red', difficulty: '⭐⭐⭐',
  image: 'Avatar/CindercoreSentry.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'IgnavarynCindercoreAutomaton', amount: 4 },
      { id: 'CinderScout', amount: 4 },
      { id: 'CindercoreSentry', amount: 4 },
...
{ id: 'Cindercore4', name: 'Pyreforge Ascendancy', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/CindercoreProtector.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Cindercore5', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/IgnavarynCindercoreAutomaton.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'IgnavarynCindercoreAutomaton', amount: 1 },
      { id: 'CinderScout', amount: 4 },
      { id: 'CindercoreSentry', amount: 4 },
...
{ id: 'Coralbound2', name: 'Depthforge Awakening', color: 'blue', difficulty: '⭐⭐',
  image: 'Avatar/CoralDrone.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Coralbound4', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐⭐⭐',
    image: 'Avatar/CoralboundProtector.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
    cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'MaelvyrnCoralboundAutomaton', amount: 4 },
      { id: 'CoralboundVanguard', amount: 3 },
      { id: 'CoralboundSentry', amount: 4 },
...
{ id: 'Coralbound6', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/MaelvyrnCoralboundAutomaton.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Golem2', name: 'Pebble Sentinels', color: ['red','gray'], difficulty: '⭐⭐',
    image: 'Avatar/FireGolem.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/RedCardback.png',
...
{ id: 'Golem4', name: 'Flameforge Guardians', color: ['red','gray'], difficulty: '⭐⭐⭐⭐',
    image: 'Avatar/GolemheartSentinel.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/RedCardback.png',
    cards: [ { id: 'Ashkar', amount: 1 },
      { id: 'SmolderingGolemheart', amount: 2 },
      { id: 'GolemheartSentinel', amount: 3 },
      { id: 'GolemheartGiant', amount: 3 },
...
{ id: 'Golem5', name: 'Pyrestone Giants', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/PyrokragGolemheartTitan.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/RedCardback.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Golem6', name: 'Forgebound Titans', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
    image: 'Avatar/KaelgorranElementalPrimordial.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/RedCardback.png',
    cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Frostland2', name: 'Shard of Winter', color: ['blue', 'gray'], difficulty: '⭐⭐',
    image: 'Avatar/FrostlandWyrm.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Frostland4', name: 'Frostbound Vanguard', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatar/EirawenFrostlandQueen.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Frostland6', name: 'Eternal Glacier', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/FrostlandRuneforgedColossus.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Umbral1', name: 'Shadowy Descent', color: 'black', difficulty: '⭐',
  image: 'Avatar/Wolf.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Umbral.png',
...
{ id: 'Skullframe4', name: 'Bone Servants Grave Sentinels  Grave Lords ', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/MaldryssSkullframeArchmage.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
...
{ id: 'Glimmerscale6', name: 'Draconic Concord', color: 'green', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/VerdarokSylvanThornwing.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
