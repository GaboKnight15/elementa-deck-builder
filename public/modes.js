const DEFAULT_DECKS = [
{ id: 'sylvan1', name: 'Verdant Might', color: 'green', difficulty: '⭐', starter: true,
...
{ id: 'sylvan2', name: 'Everdawn Wildheart', color: 'green', difficulty: '⭐⭐',
...
{ id: 'sylvan3', name: 'Worldroot Ascendancy', color: 'green', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/Green/Eryndor.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
// --- SATYR DECKS --- //
{ id: 'satyr1', name: 'Thornwine Chorus', color: 'green', difficulty: '⭐', 
...
{ id: 'satyr2', name: 'Wildroot Symphony', color: 'green', difficulty: '⭐⭐',
  image: 'Images/Avatar/Green/WildhornSongreaver.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Satyr.png',
...
{ id: 'satyr3', name: 'Primal Grove Requiem', color: 'green', difficulty: '⭐⭐⭐',
...
// --- INFERNO DECKS --- //
{ id: 'inferno1', name: 'Kindled Fury', color: 'red', difficulty: '⭐', starter: true,
...
{ id: 'fireland1', name: 'Rising Flames', color: 'red', difficulty: '⭐',
  image: 'Images/Avatar/Red/Emberling.png', bannerArt: 'Images/Banner/Volcano.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
    { id: 'Emberling', amount: 3 },
    { id: 'FirePixie', amount: 3 },
...
{ id: 'inferno2', name: 'Relentless Blaze', color: 'red', difficulty: '⭐⭐',
...
{ id: 'fireland2', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐',
...
{ id: 'fireland3', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐',
...
// --- TIDAL DECKS --- //
{ id: 'tidal1', name: 'Relentless Flow', color: 'blue', difficulty: '⭐', starter: true,
...
{ id: 'tidal2', name: 'Oceanic Supremacy', color: 'blue', difficulty: '⭐⭐',
...
{ id: 'tidal3', name: 'Tidebound Will', color: 'blue', difficulty: '⭐⭐⭐',
...
{ id: 'merfolk1', name: 'Flowing Tides', color: 'blue', difficulty: '⭐',
...
{ id: 'tempest1', name: 'Static Pulse', color: 'yellow', difficulty: '⭐', starter: true,
...
{ id: 'avian1', name: 'Feather Vanguard', color: 'yellow', difficulty: '⭐',
...
{ id: 'avian2', name: 'Sky Sovereigns', color: 'yellow', difficulty: '⭐⭐',
...
{ id: 'tempest3', name: 'Aethervolt Crash', color: 'yellow', difficulty: '⭐⭐⭐',
...
// --- TERRA DECKS --- //
{ id: 'terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐', starter: true,
  image: 'Images/Avatar/Gray/Golemites.png', bannerArt: 'Images/Banner/Mountain.png', cardbackArt: 'Images/Cardback/Stonebound.png',
...
{ id: 'orc1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
...
{ id: 'orc2', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐⭐',
...
// --- CURSED DECKS --- //
{ id: 'cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐', starter: true,
...
// --- RADIANT DECKS --- //
{ id: 'radiant1', name: 'Celestial Light', color: 'white', difficulty: '⭐', starter: true,
...
// --- UMBRAL DECKS --- //
{ id: 'umbral1', name: 'Whispered Midnight', color: 'black', difficulty: '⭐', starter: true,
...
{ id: 'zombie1', name: 'Grave Stirring', color: 'black', difficulty: '⭐',
...
{ id: 'zombie2', name: 'Necrotic Supremacy', color: 'black', difficulty: '⭐⭐',
...
{ id: 'umbral2', name: 'Shadowy Descent', color: 'black', difficulty: '⭐⭐',
...
{ id: 'umbral3', name: 'Umbral Stillness', color: 'black', difficulty: '⭐⭐⭐',
...
/*
// FRACTURED ORIGINS DECKS //
// ELF DECKS //
{ id: 'elf1', name: 'Verdant Might', color: 'green', difficulty: '⭐',
  image: 'Images/Avatar/Green/Elf.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'thornwing1', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐',
...
{ id: 'thornwing3', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐',
...
{ id: 'Skullframe2', name: 'Grave Lords', color: ['black', 'purple'], difficulty: '⭐⭐',
...
{ id: 'Skullframe3', name: 'Undead Rulers', color: ['black', 'purple'], difficulty: '⭐⭐⭐',
...
{ id: 'Fairy5', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/Green/ThistleFaeStarlight.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
// --- CINDERCORE DECKS --- //
{ id: 'Cindercore1', name: 'Emberforged Legion', color: 'red', difficulty: '⭐',
...
{ id: 'Cindercore2', name: 'Pyreforge Ascendancy', color: 'red', difficulty: '⭐⭐',
...
{ id: 'Cindercore3', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐',
...
// --- CORALBOUND DECKS --- //
{ id: 'Coralbound1', name: 'Depthforge Awakening', color: 'blue', difficulty: '⭐',
...
{ id: 'Coralbound2', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐',
...
{ id: 'Coralbound3', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐',
...
// --- GOLEM DECKS --- //
{ id: 'MagmaGolem1', name: 'Pebble Sentinels', color: ['red','gray'], difficulty: '⭐',
...
{ id: 'MagmaGolem2', name: 'Flameforge Guardians', color: ['red','gray'], difficulty: '⭐⭐',
...
{ id: 'MagmaGolem3', name: 'Pyrestone Giants', color: ['red','gray'], difficulty: '⭐⭐⭐',
...
{ id: 'Golem3', name: 'Forgebound Titans', color: ['red','gray'], difficulty: '⭐⭐⭐',
