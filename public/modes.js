...
{ id: 'Sylvan1', name: 'Sprouting Seeds', color: 'green', difficulty: '⭐',
  image: 'Images/Avatar/Fairy.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
{ id: 'Sylvan2', name: 'Verdant Might', color: 'green', difficulty: '⭐⭐',
  image: 'Images/Avatar/WoodlandAntler.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Sylvan3', name: 'Ancient Wilds', color: 'green', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/DeepwoodUrsan.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
{ id: 'Sylvan4', name: 'Everdawn Wildheart', color: 'green', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/VerdaraSoldier.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 }, { id: 'VeyaEmeraldDruidess', amount: 1 }, { id: 'SylvanAnima', amount: 1 },
    { id: 'DeepwoodUrsan', amount: 2 },
    { id: 'SylvanElf', amount: 3 },      
    { id: 'ForestFairy', amount: 3 },
...
{ id: 'Sylvan5', name: 'Worldroot Ascendancy', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Veya.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 }, { id: 'VeyaEmeraldDruidess', amount: 1 }, { id: 'SylvanAnima', amount: 1 },
    { id: 'DeepwoodUrsan', amount: 2 },
    { id: 'SylvanElf', amount: 3 },
    { id: 'ForestFairy', amount: 3 },
...
{ id: 'Satyr2', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐⭐',
  image: 'Images/Avatar/WildHuntress.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Satyr.png',
...
{ id: 'Satyr3', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐⭐',
  image: 'Images/Avatar/Faelyra.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Satyr.png',
  cards: [ { id: 'Verdara', amount: 1 }, { id: 'FaelyraWildhornEmpress', amount: 1 }, 
    { id: 'LifeGrowth', amount: 1 },
    { id: 'FaunDiviner', amount: 3 },      
    { id: 'FaunRanger', amount: 3 },
...
{ id: 'Inferno1', name: 'Kindled Fury', color: 'red', difficulty: '⭐',
  image: 'Images/Avatar/Emberling.png', bannerArt: 'Banners/Volcano.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Inferno3', name: 'Ember Tyranny', color: 'red', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/BlazescaleWarDrake.png', bannerArt: 'Banners/Volcano.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
    { id: 'Emberling', amount: 3 },
    { id: 'FirePixie', amount: 3 },
    { id: 'Hellcharger', amount: 2 },
...
{ id: 'Inferno4', name: 'Relentless Blaze', color: 'red', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/MagmarisMercenary.png', bannerArt: 'Banners/Volcano.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Inferno5', name: 'Ember Tyranny', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Kaelen.png', bannerArt: 'Banners/Volcano.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland1', name: 'Emberfang Pride', color: 'red', difficulty: '⭐',
  image: 'Images/Avatar/Kaelen.png', bannerArt: 'Images/Banner/Badland.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Fireland4', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/HenchmanofEphoros.png', bannerArt: 'Images/Banner/Badland.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland6', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Ephoros.png', bannerArt: 'Images/Banner/Badland.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelyraFirelandHeiress', amount: 1 },
    { id: 'EphorosFirelandBehemoth', amount: 1 },
    { id: 'HenchmanofEphoros', amount: 1 },
    { id: 'FirelandHellmaw', amount: 2 },
...
{ id: 'Tidal1', name: 'Flowing Tides', color: 'blue', difficulty: '⭐',
  image: 'Images/Avatar/Mermaid.png', bannerArt: 'Images/Banner/Ocean.png', cardbackArt: 'Images/Cardback/Merfolk.png',
...
{ id: 'Tidal2', name: 'Relentless Flow', color: 'blue', difficulty: '⭐⭐',
  image: 'Images/Avatar/RuneboundShark.png', bannerArt: 'Images/Banner/Ocean.png', cardbackArt: 'Images/Cardback/Merfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'WaterElemental', amount: 3 },
    { id: 'TidecallersPearl', amount: 3 },
    { id: 'EssenceRift', amount: 3 },
...
{ id: 'Tidal3', name: 'Oceanic Supremacy', color: 'blue', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/WavecrashWhale.png', bannerArt: 'Images/Banner/Ocean.png', cardbackArt: 'Images/Cardback/Merfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'WaterElemental', amount: 3 },
    { id: 'TidecallersPearl', amount: 3 },
    { id: 'EssenceRift', amount: 3 },
...
{ id: 'Tidal4', name: 'Tidebound Will', color: 'blue', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/UmarionPaladin.png', bannerArt: 'Images/Banner/Umarion.png', cardbackArt: 'Images/Cardback/Merfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'WaterElemental', amount: 3 },
    { id: 'TidecallersPearl', amount: 3 },
    { id: 'EssenceRift', amount: 3 },
...
{ id: 'Tidal5', name: 'Maelstrom Sovereignty', color: 'blue', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Serenya.png', bannerArt: 'Images/Banner/Umarion.png', cardbackArt: 'Images/Cardback/Merfolk.png',
...
{ id: 'Tempest1', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐',
  image: 'Images/Avatar/Thunderspawn.png', bannerArt: 'Images/Banner/Peaks.png', cardbackArt: 'Images/Cardback/Stormcore.png',
  cards: [ { id: 'Aetherion', amount: 1 },
    { id: 'StormcoreDynamo', amount: 3 },
    { id: 'EssenceBolt', amount: 3 },
    { id: 'Peaks', amount: 3 },
]},
{ id: 'Tempest2', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐⭐',
  image: 'Images/Avatar/Thunderspawn.png', bannerArt: 'Images/Banner/Peaks.png', cardbackArt: 'Images/Cardback/Stormcore.png',
  cards: [ { id: 'Aetherion', amount: 1 },
    { id: 'StormcoreDynamo', amount: 3 },
    { id: 'EssenceBolt', amount: 3 },
...
{ id: 'Tempest3', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/GalestrikeRoc.png', bannerArt: 'Images/Banner/Peaks.png', cardbackArt: 'Images/Cardback/Stormcore.png',
  cards: [ { id: 'Aetherion', amount: 1 },
    { id: 'StormcoreDynamo', amount: 3 },
    { id: 'EssenceBolt', amount: 3 },
    { id: 'Peaks', amount: 3 },
...
{ id: 'Tempest4', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/AetherionElectromancer.png', bannerArt: 'Images/Banner/Aetherion.png', cardbackArt: 'Images/Cardback/Stormcore.png',
  cards: [ { id: 'Aetherion', amount: 1 },
    { id: 'StormcoreDynamo', amount: 3 },
...
{ id: 'Tempest5', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Zyra.png', bannerArt: 'Images/Banner/Aetherion.png', cardbackArt: 'Images/Cardback/Stormcore.png',
...
{ id: 'Terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
  image: 'Images/Avatar/RockshellArmadillo.png', bannerArt: 'Images/Banner/Mountain.png', cardbackArt: 'Images/Cardback/Stonebound.png',
...
{ id: 'Terra2', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐⭐',
  image: 'Images/Avatar/Orc.png', bannerArt: 'Images/Banner/Mountain.png', cardbackArt: 'Images/Cardback/Stonebound.png',
  cards: [ { id: 'Drakzul', amount: 1 },
    { id: 'Golemites', amount: 3 },
    { id: 'DesertWolf', amount: 3 },
    { id: 'TitansAnvil', amount: 3 },
...
{ id: 'Terra3', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/RockmaulRhino.png', bannerArt: 'Images/Banner/Mountain.png', cardbackArt: 'Images/Cardback/Stonebound.png',
  cards: [ { id: 'Drakzul', amount: 1 },
    { id: 'Golemites', amount: 3 },
    { id: 'DesertWolf', amount: 3 },
    { id: 'TitansAnvil', amount: 3 },
...
{ id: 'Terra4', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/DrakzulWarmonger.png', bannerArt: 'Images/Banner/Drakzul.png', cardbackArt: 'Images/Cardback/Stonebound.png',
  cards: [ { id: 'Drakzul', amount: 1 },
    { id: 'Golemites', amount: 3 },
    { id: 'DesertWolf', amount: 3 },
    { id: 'TitansAnvil', amount: 3 },
...
{ id: 'Terra5', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Rudgar.png', bannerArt: 'Images/Banner/Drakzul.png', cardbackArt: 'Images/Cardback/Stonebound.png',
  cards: [ { id: 'Drakzul', amount: 1 },
    { id: 'Golemites', amount: 3 },
    { id: 'DesertWolf', amount: 3 },
    { id: 'TitansAnvil', amount: 3 },
...
{ id: 'Cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐',
  image: 'Images/Avatar/GiantHornet.png', bannerArt: 'Images/Banner/Swamp.png', cardbackArt: 'Images/Cardback/Goblin.png',
...
{ id: 'Cursed2', name: 'Venom Bloom', color: 'purple', difficulty: '⭐⭐',
  image: 'Images/Avatar/FenGoblin.png', bannerArt: 'Images/Banner/Swamp.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Virkul', amount: 1 },
    { id: 'Goblin', amount: 3 },
    { id: 'PlagueThornTalisman', amount: 3 },
    { id: 'ToxicSpores', amount: 3 },
...
{ id: 'Cursed3', name: 'Venom Bloom', color: 'purple', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/DreadcoilViper.png', bannerArt: 'Images/Banner/Swamp.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Virkul', amount: 1 },
    { id: 'Goblin', amount: 3 },
    { id: 'PlagueThornTalisman', amount: 3 },
    { id: 'ToxicSpores', amount: 3 },
...
{ id: 'Cursed4', name: 'Venom Bloom', color: 'purple', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/VirkulAssassin.png', bannerArt: 'Images/Banner/Virkul.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Virkul', amount: 1 },
    { id: 'Goblin', amount: 3 },
    { id: 'PlagueThornTalisman', amount: 3 },
    { id: 'ToxicSpores', amount: 3 },
...
{ id: 'Cursed5', name: 'Venom Bloom', color: 'purple', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Selgor.png', bannerArt: 'Images/Banner/Virkul.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Virkul', amount: 1 },
    { id: 'Goblin', amount: 3 },
    { id: 'PlagueThornTalisman', amount: 3 },
    { id: 'ToxicSpores', amount: 3 },
...
{ id: 'Radiant1', name: 'Celestial Light', color: 'white', difficulty: '⭐',
  image: 'Images/Avatar/Angel.png', bannerArt: 'Images/Banner/Plains.png', cardbackArt: 'Images/Cardback/Radiant.png',
...
{ id: 'Radiant2', name: 'Radiant Oath', color: 'white', difficulty: '⭐⭐',
  image: 'Images/Avatar/Valkyrie.png', bannerArt: 'Images/Banner/Plains.png', cardbackArt: 'Images/Cardback/Radiant.png',
  cards: [ { id: 'Solmara', amount: 1 },
    { id: 'ElementalofLusters', amount: 2 },
    { id: 'AngelicWarrior', amount: 3 },
    { id: 'Angel', amount: 3 },
...
{ id: 'Radiant3', name: 'Sacred Charge', color: 'white', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/Pegasus.png', bannerArt: 'Images/Banner/Plains.png', cardbackArt: 'Images/Cardback/Radiant.png',
  cards: [ { id: 'Solmara', amount: 1 },
    { id: 'ElementalofLusters', amount: 2 },
    { id: 'AngelicWarrior', amount: 3 },
    { id: 'Angel', amount: 3 },
...
{ id: 'Radiant4', name: 'Sanctified Authority', color: 'white', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/SolmaraCrusader.png', bannerArt: 'Images/Banner/Solmara.png', cardbackArt: 'Images/Cardback/Radiant.png',
  cards: [ { id: 'Solmara', amount: 1 },
    { id: 'ElementalofLusters', amount: 2 },
    { id: 'AngelicWarrior', amount: 3 },
    { id: 'Angel', amount: 3 },
...
{ id: 'Radiant5', name: 'Radiant Oath', color: 'white', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Elyndra.png', bannerArt: 'Images/Banner/Solmara.png', cardbackArt: 'Images/Cardback/Radiant.png',
...
{ id: 'Umbral1', name: 'Whispered Midnight', color: 'black', difficulty: '⭐',
  image: 'Images/Avatar/Wolf.png', bannerArt: 'Images/Banner/Shadowland.png', cardbackArt: 'Images/Cardback/Umbral.png',
...
{ id: 'Umbral2', name: 'Grave Stirring', color: 'black', difficulty: '⭐⭐',
  image: 'Images/Avatar/Zombie.png', bannerArt: 'Images/Banner/Shadowland.png', cardbackArt: 'Images/Cardback/Umbral.png',
  cards: [ { id: 'Nocthyra', amount: 1 },
    { id: 'Wolf', amount: 3 },
    { id: 'NoctyraEnforcer', amount: 2 },
    { id: 'GraveweaverWarlock', amount: 2 },
...
{ id: 'Umbral3', name: 'Necrotic Supremacy', color: 'black', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/GraveweaverWarlock.png', bannerArt: 'Images/Banner/Shadowland.png', cardbackArt: 'Images/Cardback/Umbral.png',
  cards: [ { id: 'Nocthyra', amount: 1 },
    { id: 'Wolf', amount: 3 },
    { id: 'NoctyraEnforcer', amount: 2 },
    { id: 'GraveweaverWarlock', amount: 2 },
...
{ id: 'Umbral4', name: 'Shadowy Descent', color: 'black', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/NoctyraEnforcer.png', bannerArt: 'Images/Banner/Noctyra.png', cardbackArt: 'Images/Cardback/Umbral.png',
  cards: [ { id: 'Nocthyra', amount: 1 },
    { id: 'Wolf', amount: 3 },
    { id: 'NoctyraEnforcer', amount: 2 },
    { id: 'GraveweaverWarlock', amount: 2 },
...
{ id: 'Umbral5', name: 'Umbral Stillness', color: 'black', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Velmira.png', bannerArt: 'Images/Banner/Noctyra.png', cardbackArt: 'Images/Cardback/Umbral.png',
...
{ id: 'Elf1', name: 'Verdant Might', color: 'green', difficulty: '⭐',
  image: 'Images/Avatar/Fairy.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Fairy3', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐',
  image: 'Images/Avatar/FairyWarrior.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Thornwing3', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐⭐',
  image: 'Images/Avatar/VerdantSerpent.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Verdarok.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore2', name: 'Emberforged Legion', color: 'red', difficulty: '⭐⭐',
    image: 'Images/Avatar/CinderScout.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
...
{ id: 'Cindercore3', name: 'Blazewrought Core', color: 'red', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/CindercoreSentry.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
    { id: 'IgnavarynCindercoreAutomaton', amount: 3 },
    { id: 'CinderScout', amount: 3 },
    { id: 'CindercoreSentry', amount: 3 },
...
{ id: 'Cindercore4', name: 'Pyreforge Ascendancy', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/CindercoreProtector.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Cindercore5', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Ignavaryn.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
    { id: 'IgnavarynCindercoreAutomaton', amount: 1 },
    { id: 'CinderScout', amount: 3 },
    { id: 'CindercoreSentry', amount: 3 },
...
{ id: 'Coralbound2', name: 'Depthforge Awakening', color: 'blue', difficulty: '⭐⭐',
  image: 'Images/Avatar/CoralDrone.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Coralbound4', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/CoralboundProtector.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'MaelvyrnCoralboundAutomaton', amount: 3 },
    { id: 'CoralboundVanguard', amount: 3 },
    { id: 'CoralboundSentry', amount: 3 },
...
{ id: 'Coralbound6', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Maelvyrn.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Golem5', name: 'Pyrestone Giants', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Pyrokrag.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Golem.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Golem6', name: 'Forgebound Titans', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Kaelgorran.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Golem.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Frostland2', name: 'Shard of Winter', color: ['blue', 'gray'], difficulty: '⭐⭐',
  image: 'Images/Avatar/FrostlandWyrm.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Frostland4', name: 'Frostbound Vanguard', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/Eirawen.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'EirawenFrostlandQueen', amount: 1 },      
    { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
    { id: 'FrostlandRuneforgedAutomaton', amount: 3 },
...
{ id: 'Frostland6', name: 'Eternal Glacier', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/FrostlandRuneforgedColossus.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'EirawenFrostlandQueen', amount: 1 },      
    { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
    { id: 'FrostlandRuneforgedAutomaton', amount: 3 },
...
{ id: 'Skullframe1', name: 'Bone Servants', color: 'black', difficulty: '⭐',
  image: 'Images/Avatar/Skeleton.png', bannerArt: 'Images/Banner/Graveyard.png', cardbackArt: 'Images/Cardback/Skullframe.png',
...
{ id: 'Skullframe2', name: 'Grave Sentinels', color: ['black', 'purple'], difficulty: '⭐⭐',
  image: 'Images/Avatar/UnyieldingSoul.png', bannerArt: 'Images/Banner/Graveyard.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Noctyra', amount: 1 },      
...
{ id: 'Skullframe4', name: 'Grave Lords', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/SkullframeHexmistress.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
...
{ id: 'Skullframe5', name: 'Undead Rulers', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Maldryss.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Noctyra', amount: 1 }, { id: 'MaldryssSkullframeArchmage', amount: 1 },      
    { id: 'SkullframeHexmistress', amount: 2 }, { id: 'SkullframeSpectralDragon', amount: 2 },
    { id: 'SkullframeArmoredDragon', amount: 3 },
    { id: 'SkullframeCryptwinds', amount: 3 },
...
{ id: 'Glimmerscale6', name: 'Draconic Concord', color: 'green', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Mythandriel.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
