const DEFAULT_CPU_DECKS = [
  ...
  { id: 'Inferno1',
    ...
    cards: [
      { id: 'Ashkar', amount: 1 },
      { id: 'KaelenBlazebornHuntress', amount: 1 },
...
// -------------- //
  ...
  { id: 'Satyr2',
    ...
    color: ['green', 'purple'],
    difficulty: '⭐⭐',
    image: 'CardImages/Avatars/FaelyraSatyrPrincess.png',
    bannerArt: 'CardImages/Banners/GreenBanner.png',
    cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
    cards: [
      { id: 'Verdara', amount: 1 },
      ...
      { id: 'LifeGrowth', amount: 4 },
      { id: 'VerdantRebirth', amount: 3 },
      { id: 'ArborCommunion', amount: 4 },
      { id: 'EmeraldVeil', amount: 3 },
      { id: 'Forest', amount: 4 },
      // ... etc
    ]
  },
  { id: 'Treant2',
    ...
    color: ['green', 'black'],
    difficulty: '⭐⭐',
    image: 'CardImages/Avatars/TreantWitch.png',
    bannerArt: 'CardImages/Banners/GreenBanner.png',
    cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
    cards: [
      { id: 'Verdara', amount: 1 },
