...
{ id: 'Sylvan1', name: 'Verdant Might', color: 'green', difficulty: '⭐',
  image: 'Avatars/Fairy.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
...
{ id: 'Satyr1', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐',
  image: 'Avatars/FaunDiviner.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Inferno1', name: 'Ember Tyranny', color: 'red', difficulty: '⭐',
  image: 'Avatars/Emberling.png', bannerArt: 'Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFirelands.png',
...
{ id: 'Fireland1', name: 'Emberfang Pride', color: 'red', difficulty: '⭐',
  image: 'FirelandScamperling.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Tidal1', name: 'Tidebound Will', color: 'blue', difficulty: '⭐',
  image: 'Avatars/WaterElemental.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMerfolk.png',
...
{ id: 'Tempest1', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐',
  ...
  { id: 'Terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
    image: 'Avatars/RockLizard.png', bannerArt: 'CardImages/Banners/GrayBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBStonebound.png',
...
{ id: 'Cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐',
  image: 'Avatars/Goblin.png', bannerArt: 'CardImages/Banners/PurpleBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBGoblins.png',
...
{ id: 'Radiant1', name: 'Radiant Oath', color: 'white', difficulty: '⭐',
    image: 'Avatars/AngelicWarrior.png', bannerArt: 'CardImages/Banners/WhiteBanner.png', cardbackArt: 'OtherImages/Cardbacks/WhiteCardback.png',
...
{ id: 'Umbral1', name: 'Shadowy Descent', color: 'black', difficulty: '⭐',
  image: 'Avatars/Wolf.png', bannerArt: 'CardImages/Banners/BlackBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMoonfang.png',
...
{ id: 'Satyr2', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐⭐',
    image: 'CardImages/Avatars/FaunRanger.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'FaunRanger', amount: 4 },
      { id: 'WildHuntress', amount: 4 },
...
{ id: 'Treant2', name: 'Oakhaven Awakening', color: ['green', 'black'], difficulty: '⭐⭐',
    image: 'Avatars/TreantWitch.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Golem2', name: 'Forgebound Titans', color: ['red','gray'], difficulty: '⭐⭐',
    image: 'Avatars/Emberling.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/RedCardback.png',
...
{ id: 'Thornwing3', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐⭐',
    image: 'Avatars/VerdantSerpent.png',
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatars/VerdarokSylvanWarden.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore2', name: 'Emberforged Legion', color: 'red', difficulty: '⭐⭐',
    image: 'Avatars/CinderScout.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMerfolk.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Cindercore5', name: 'Pyreforge Ascendancy Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatars/IgnavarynCindercoreAutomaton.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Coralbound2', name: 'Depthforge Awakening Tidewrought Vanguard The Eternal Reef', color: 'blue', difficulty: '⭐⭐',
  image: 'Avatars/CoralDrone.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
  { id: 'WaterElemental', amount: 4 },
...
{ id: 'Coralbound4', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐⭐⭐',
    image: 'Avatars/CoralboundProtector.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBMerfolk.png',
    cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'WaterElemental', amount: 4 },
      { id: 'CoralDrone', amount: 4 },
      { id: 'CoralboundSentry', amount: 4 },
...
{ id: 'Coralbound6', name: 'Eternal Reef', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatars/MaelvyrnCoralboundAutomaton.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBCoralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'WaterElemental', amount: 4 },
      { id: 'CoralDrone', amount: 4 },
      { id: 'CoralboundSentry', amount: 4 },
...
{ id: 'Fireland4', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatars/KaelyraFirelandHeiress.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFireland.png',
...
{ id: 'Frostland2', name: 'Shard of Winter', color: ['blue', 'gray'], difficulty: '⭐⭐',
    image: 'Avatars/FrostlandWyrm.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Frostland4', name: 'Frostbound Vanguard', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatars/EirawenFrostlandQueen.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Skullframe5', name: 'Everbloom Harmony', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatars/MaldryssSkullframeArchmage.png', bannerArt: 'CardImages/Banners/BlackBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBSkullframe.png',
...
{ id: 'Skullframe5', name: 'Everbloom Harmony', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
    image: 'Avatars/MaldryssSkullframeArchmage.png',
...
{ id: 'Glimmerscale6', name: 'Draconic Concord', color: 'green', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatars/VerdarokSylvanThornwing.png', bannerArt: 'CardImages/Banners/GreenBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Fireland6', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatars/EphorosFirelandBehemoth.png', bannerArt: 'CardImages/Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelyraFirelandHeiress', amount: 1 },
      { id: 'EphorosFirelandBehemoth', amount: 1 },
      { id: 'HenchmanofEphoros', amount: 1 },
      { id: 'FirelandHellmaw', amount: 2 },
...
{ id: 'Frostland6', name: 'Eternal Glacier', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatars/FrostlandRuneforgedColossus.png', bannerArt: 'CardImages/Banners/BlueBanner.png', cardbackArt: 'OtherImages/Cardbacks/CBFairy.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
