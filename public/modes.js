...
{ id: 'Goblin1', name: 'Thornwine Chorus', color: ['green', 'red', 'gray', 'purple', 'black'], difficulty: '⭐',
  image: 'Images/Avatar/Goblin.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Goblin.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Inferno1', name: 'Ember Tyranny', color: 'red', difficulty: '⭐',
  image: 'Images/Avatar/Emberling.png', bannerArt: 'Banners/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland1', name: 'Emberfang Pride', color: 'red', difficulty: '⭐',
  image: 'Images/Avatar/KaelenBlazebornHuntress.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Fireland4', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/HenchmanofEphoros.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
...
{ id: 'Fireland6', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/EphorosFirelandBehemoth.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Fireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelyraFirelandHeiress', amount: 1 },
      { id: 'EphorosFirelandBehemoth', amount: 1 },
      { id: 'HenchmanofEphoros', amount: 1 },
      { id: 'FirelandHellmaw', amount: 2 },
...
{ id: 'Tidal1', name: 'Tidebound Will', color: 'blue', difficulty: '⭐',
  image: 'Images/Avatar/WaterElemental.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Merfolk.png',
...
{ id: 'Tempest1', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐',
  ...
  { id: 'Terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
    image: 'Images/Avatar/RockLizard.png', bannerArt: 'Images/Banner/GrayBanner.png', cardbackArt: 'Images/Cardback/Stonebound.png',
...
{ id: 'Cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐',
  image: 'Images/Avatar/Goblin.png', bannerArt: 'Images/Banner/PurpleBanner.png', cardbackArt: 'Images/Cardback/Goblin.png',
...
{ id: 'Radiant1', name: 'Radiant Oath', color: 'white', difficulty: '⭐',
    image: 'Images/Avatar/AngelicWarrior.png', bannerArt: 'Images/Banner/WhiteBanner.png', cardbackArt: 'Images/Cardback/Radiant.png',
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/VerdarokSylvanWarden.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore5', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/IgnavarynCindercoreAutomaton.png', bannerArt: 'Images/Banner/RedBanner.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'IgnavarynCindercoreAutomaton', amount: 1 },
      { id: 'CinderScout', amount: 4 },
      { id: 'CindercoreSentry', amount: 4 },
...
{ id: 'Coralbound6', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/MaelvyrnCoralboundAutomaton.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Frostland4', name: 'Frostbound Vanguard', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/EirawenFrostlandQueen.png', bannerArt: 'Images/Banner/BlueBanner.png', cardbackArt: 'Images/Cardback/Frostland.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Umbral1', name: 'Shadowy Descent', color: 'black', difficulty: '⭐',
  image: 'Images/Avatar/Wolf.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Umbral.png',
...
{ id: 'Skullframe1', name: 'Bone Servants', color: 'black', difficulty: '⭐',
  image: 'Images/Avatar/Skeleton.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 },      
...
{ id: 'Skullframe2', name: 'Grave Sentinels', color: ['black', 'purple'], difficulty: '⭐⭐',
  image: 'Images/Avatar/UnyieldingSoul.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 },      
...
{ id: 'Skullframe5', name: 'Undead Rulers', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/MaldryssSkullframeArchmage.png', bannerArt: 'Images/Banner/BlackBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 }, { id: 'MaldryssSkullframeArchmage', amount: 1 },      
      { id: 'SkullframeHexmistress', amount: 2 }, { id: 'SkullframeSpectralDragon', amount: 2 },
      { id: 'SkullframeArmoredDragon', amount: 3 },
      { id: 'SkullframeCryptwinds', amount: 3 },
...
{ id: 'Glimmerscale6', name: 'Draconic Concord', color: 'green', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/VerdarokSylvanThornwing.png', bannerArt: 'Images/Banner/GreenBanner.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
