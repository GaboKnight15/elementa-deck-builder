...
{ id: 'Radiant3', name: 'Sacred Charge', color: 'white', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/SkylionExemplar.png', bannerArt: 'Images/Banner/Plains.png', cardbackArt: 'Images/Cardback/Radiant.png',
  cards: [ { id: 'Solmara', amount: 1 },
...
{ id: 'Fairy3', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐',
  image: 'Images/Avatar/FairyWarrior.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Fairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Fairy5', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Fairy.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Fairy.png',
...
{ id: 'Arbor2', name: 'Oakhaven Awakening', color: ['green', 'black'], difficulty: '⭐⭐',
  image: 'Images/Avatar/TreantWitch.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Arbor.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing3', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐⭐',
  image: 'Images/Avatar/VerdantSerpent.png', bannerArt: 'Images/Banner/Forest.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Verdarok.png', bannerArt: 'Images/Banner/Verdara.png', cardbackArt: 'Images/Cardback/Thornwing.png',
  cards: [ { id: 'Verdara', amount: 1 },
    { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore2', name: 'Emberforged Legion', color: 'red', difficulty: '⭐⭐',
    image: 'Images/Avatar/CinderScout.png', bannerArt: 'Images/Banner/Volcano.png', cardbackArt: 'Images/Cardback/Cindercore.png',
...
{ id: 'Cindercore3', name: 'Blazewrought Core', color: 'red', difficulty: '⭐⭐⭐',
  image: 'Images/Avatar/CindercoreSentry.png', bannerArt: 'Images/Banner/Volcano.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
    { id: 'IgnavarynCindercoreAutomaton', amount: 3 },
    { id: 'CinderScout', amount: 3 },
    { id: 'CindercoreSentry', amount: 3 },
...
{ id: 'Cindercore4', name: 'Pyreforge Ascendancy', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/CindercoreProtector.png', bannerArt: 'Images/Banner/Magmaris.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Cindercore5', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Ignavaryn.png', bannerArt: 'Images/Banner/Magmaris.png', cardbackArt: 'Images/Cardback/Cindercore.png',
  cards: [ { id: 'Ashkar', amount: 1 },
    { id: 'IgnavarynCindercoreAutomaton', amount: 1 },
    { id: 'CinderScout', amount: 3 },
    { id: 'CindercoreSentry', amount: 3 },
...
{ id: 'Coralbound2', name: 'Depthforge Awakening', color: 'blue', difficulty: '⭐⭐',
  image: 'Images/Avatar/CoralDrone.png', bannerArt: 'Images/Banner/Ocean.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Coralbound4', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐⭐⭐',
  image: 'Images/Avatar/CoralboundProtector.png', bannerArt: 'Images/Banner/Umarion.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
    { id: 'MaelvyrnCoralboundAutomaton', amount: 3 },
    { id: 'CoralboundVanguard', amount: 3 },
    { id: 'CoralboundSentry', amount: 3 },
...
{ id: 'Coralbound6', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Maelvyrn.png', bannerArt: 'Images/Banner/Umarion.png', cardbackArt: 'Images/Cardback/Coralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Golem2', name: 'Pebble Sentinels', color: ['red','gray'], difficulty: '⭐⭐',
  image: 'Images/Avatar/FireGolem.png', bannerArt: 'Images/Banner/Volcano.png', cardbackArt: 'Images/Cardback/Golem.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Skullframe4', name: 'Grave Lords', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/SkullframeHexmistress.png', bannerArt: 'Images/Banner/Graveyard.png', cardbackArt: 'Images/Cardback/Skullframe.png',
...
{ id: 'Skullframe5', name: 'Undead Rulers', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Images/Avatar/Maldryss.png', bannerArt: 'Images/Banner/Graveyard.png', cardbackArt: 'Images/Cardback/Skullframe.png',
  cards: [ { id: 'Noctyra', amount: 1 }, { id: 'MaldryssSkullframeArchmage', amount: 1 },      
    { id: 'SkullframeHexmistress', amount: 2 }, { id: 'SkullframeSpectralDragon', amount: 2 },
    { id: 'SkullframeArmoredDragon', amount: 3 },
    { id: 'SkullframeCryptwinds', amount: 3 },
