...
{ id: 'Goblin1', name: 'Thornwine Chorus', color: ['green', 'red', 'gray', 'purple', 'black'], difficulty: '⭐',
  image: 'Avatar/Goblin.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBGoblin.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'WildHuntress', amount: 4 },
      { id: 'FaunRanger', amount: 4 },
...
{ id: 'Satyr1', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐',
  image: 'Avatar/Satyr.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'WildHuntress', amount: 4 },
      { id: 'FaunRanger', amount: 4 },
...
{ id: 'Satyr2', name: 'Thornwine Chorus', color: ['green', 'purple'], difficulty: '⭐⭐',
    image: 'CardImages/Avatar/FaunRanger.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
      { id: 'FaunDiviner', amount: 4 },      
      { id: 'FaunRanger', amount: 4 },
      { id: 'WildHuntress', amount: 4 },
      { id: 'ElderwoodOccultist', amount: 4 },
      { id: 'SummitWatcher', amount: 4 },
...
{ id: 'Inferno1', name: 'Ember Tyranny', color: 'red', difficulty: '⭐',
  image: 'Avatar/Emberling.png', bannerArt: 'Banners/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBFirelands.png',
...
{ id: 'Fireland1', name: 'Emberfang Pride', color: 'red', difficulty: '⭐',
  image: 'Avatar/KaelenBlazebornHuntress.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBFireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelenBlazebornHuntress', amount: 1 },
...
{ id: 'Fireland4', name: 'Ashmaw Brood', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatar/HenchmanofEphoros.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBFireland.png',
...
{ id: 'Fireland6', name: 'Infernal Apex', color: ['red', 'black'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/EphorosFirelandBehemoth.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBFireland.png',
  cards: [ { id: 'Ashkar', amount: 1 }, { id: 'KaelyraFirelandHeiress', amount: 1 },
      { id: 'EphorosFirelandBehemoth', amount: 1 },
      { id: 'HenchmanofEphoros', amount: 1 },
      { id: 'FirelandHellmaw', amount: 2 },
...
{ id: 'Tidal1', name: 'Tidebound Will', color: 'blue', difficulty: '⭐',
  image: 'Avatar/WaterElemental.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
...
{ id: 'Tempest1', name: 'Surgecallers Rite', color: 'yellow', difficulty: '⭐',
    image: 'CardImages/Avatar/Thunderspawn.png', bannerArt: 'CardImages/Banner/YellowBanner.png', cardbackArt: 'OtherImages/Cardback/CBStormcore.png',
  ...
  { id: 'Terra1', name: 'Ironroot Vow', color: 'gray', difficulty: '⭐',
    image: 'Avatar/RockLizard.png', bannerArt: 'CardImages/Banner/GrayBanner.png', cardbackArt: 'OtherImages/Cardback/CBStonebound.png',
...
{ id: 'Cursed1', name: 'Venom Bloom', color: 'purple', difficulty: '⭐',
  image: 'Avatar/Goblin.png', bannerArt: 'CardImages/Banner/PurpleBanner.png', cardbackArt: 'OtherImages/Cardback/CBGoblins.png',
...
{ id: 'Radiant1', name: 'Radiant Oath', color: 'white', difficulty: '⭐',
    image: 'Avatar/AngelicWarrior.png', bannerArt: 'CardImages/Banner/WhiteBanner.png', cardbackArt: 'OtherImages/Cardback/WhiteCardback.png',
...
// -------------- //
  { id: 'Elf1', name: 'Verdant Might', color: 'green', difficulty: '⭐',
    ...
    cards: [ { id: 'Verdara', amount: 1 },
      ...
      { id: 'ForestWarrior', amount: 3 },
      { id: 'HeartwoodRelic', amount: 4 },
      { id: 'LifeGrowth', amount: 2 }, { id: 'VerdantRebirth', amount: 3 }, { id: 'EssenceSurge', amount: 4 },
      { id: 'SylvanCanopy', amount: 4 }, { id: 'Forest', amount: 4 },
]},
...
{ id: 'Fairy3', name: 'Everbloom Harmony', color: ['green', 'white'], difficulty: '⭐⭐',
  image: 'Avatar/FairyWarrior.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
...
{ id: 'Arbor2', name: 'Oakhaven Awakening', color: ['green', 'black'], difficulty: '⭐⭐',
    image: 'Avatar/TreantWitch.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
    cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing3', name: 'Wyrms of the Wildroot', color: 'green', difficulty: '⭐⭐',
  image: 'Avatar/VerdantSerpent.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Thornwing5', name: 'Scales of Protection', color: 'green', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/VerdarokSylvanWarden.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
{ id: 'Cindercore2', name: 'Emberforged Legion', color: 'red', difficulty: '⭐⭐',
    image: 'Avatar/CinderScout.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Cindercore3', name: 'Blazewrought Core', color: 'red', difficulty: '⭐⭐⭐',
  image: 'Avatar/CindercoreSentry.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'IgnavarynCindercoreAutomaton', amount: 4 },
      { id: 'CinderScout', amount: 4 },
      { id: 'CindercoreSentry', amount: 4 },
...
{ id: 'Cindercore4', name: 'Pyreforge Ascendancy', color: 'red', difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/CindercoreProtector.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Cindercore5', name: 'Infernal Crucible', color: 'red', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/IgnavarynCindercoreAutomaton.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'IgnavarynCindercoreAutomaton', amount: 1 },
      { id: 'CinderScout', amount: 4 },
      { id: 'CindercoreSentry', amount: 4 },
...
{ id: 'Coralbound2', name: 'Depthforge Awakening', color: 'blue', difficulty: '⭐⭐',
  image: 'Avatar/CoralDrone.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
  cards: [ { id: 'Marinthae', amount: 1 },
  { id: 'MaelvyrnCoralboundAutomaton', amount: 4 },
...
{ id: 'Coralbound4', name: 'Tidewrought Vanguard', color: 'blue', difficulty: '⭐⭐⭐⭐',
    image: 'Avatar/CoralboundProtector.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBMerfolk.png',
    cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'MaelvyrnCoralboundAutomaton', amount: 4 },
      { id: 'CoralboundVanguard', amount: 3 },
      { id: 'CoralboundSentry', amount: 4 },
...
{ id: 'Coralbound6', name: 'Coralheart Bastion', color: 'blue', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/MaelvyrnCoralboundAutomaton.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBCoralbound.png',
  cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Golem2', name: 'Pebble Sentinels', color: ['red','gray'], difficulty: '⭐⭐',
    image: 'Avatar/FireGolem.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/RedCardback.png',
...
{ id: 'Golem4', name: 'Flameforge Guardians', color: ['red','gray'], difficulty: '⭐⭐⭐⭐',
    image: 'Avatar/GolemheartSentinel.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/RedCardback.png',
    cards: [ { id: 'Ashkar', amount: 1 },
      { id: 'SmolderingGolemheart', amount: 2 },
      { id: 'GolemheartSentinel', amount: 3 },
      { id: 'GolemheartGiant', amount: 3 },
...
{ id: 'Golem5', name: 'Pyrestone Giants', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/PyrokragGolemheartTitan.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/RedCardback.png',
  cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Golem6', name: 'Forgebound Titans', color: ['red','gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
    image: 'Avatar/KaelgorranElementalPrimordial.png', bannerArt: 'CardImages/Banner/RedBanner.png', cardbackArt: 'OtherImages/Cardback/RedCardback.png',
    cards: [ { id: 'Ashkar', amount: 1 },
...
{ id: 'Frostland2', name: 'Shard of Winter', color: ['blue', 'gray'], difficulty: '⭐⭐',
    image: 'Avatar/FrostlandWyrm.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
    cards: [ { id: 'Marinthae', amount: 1 },
...
{ id: 'Frostland4', name: 'Frostbound Vanguard', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐',
  image: 'Avatar/EirawenFrostlandQueen.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Frostland6', name: 'Eternal Glacier', color: ['blue', 'gray'], difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/FrostlandRuneforgedColossus.png', bannerArt: 'CardImages/Banner/BlueBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Marinthae', amount: 1 },
      { id: 'EirawenFrostlandQueen', amount: 1 },      
      { id: 'FrostlandRuneforgedColossus', amount: 1 }, { id: 'FrostlandDragon', amount: 1 },
      { id: 'FrostlandRuneforgedAutomaton', amount: 4 },
...
{ id: 'Umbral1', name: 'Shadowy Descent', color: 'black', difficulty: '⭐',
  image: 'Avatar/Wolf.png', bannerArt: 'CardImages/Banner/BlackBanner.png', cardbackArt: 'OtherImages/Cardback/CBMoonfang.png',
  cards: [ { id: 'Nocthyra', amount: 1 },
      ...
      { id: 'Shadowland', amount: 4 },
]},

// --- SKULLFRAME DECKS --- //
{ id: 'Skullframe4', name: 'Bone Servants Grave Sentinels  Grave Lords ', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
  image: 'Avatar/MaldryssSkullframeArchmage.png', bannerArt: 'CardImages/Banner/BlackBanner.png', cardbackArt: 'OtherImages/Cardback/CBSkullframe.png',
  cards: [ { id: 'Verdara', amount: 1 }, { id: 'MaldryssSkullframeArchmage', amount: 1 },      
      ...
      { id: 'Boneyard', amount: 3 }, { id: 'Shadowland', amount: 4 },
]},
{ id: 'Skullframe5', name: 'Eternal Undead Rulers', color: ['black', 'purple'], difficulty: '⭐⭐⭐⭐⭐',
    image: 'Avatar/MaldryssSkullframeArchmage.png',
    bannerArt: 'CardImages/Banner/BlackBanner.png',
    cardbackArt: 'OtherImages/Cardback/CBSkullframe.png',
    cards: [ { id: 'Verdara', amount: 1 }, { id: 'MaldryssSkullframeArchmage', amount: 1 },      
      { id: 'SkullframeHexmistress', amount: 2 }, { id: 'SkullframeSpectralDragon', amount: 2 },
      { id: 'SkullframeArmoredDragon', amount: 3 },
      { id: 'SkullframeCryptwinds', amount: 3 },
      ...
      { id: 'SkullframeDefector', amount: 4 },
      { id: 'Skeleton', amount: 4 },
      { id: 'Soulhexing', amount: 4 }, { id: 'Witherwake', amount: 3 }, { id: 'EssencePurge', amount: 4 },
      { id: 'Boneyard', amount: 3 }, { id: 'Shadowland', amount: 4 },
]},

// --- GLIMMERSCALE DECKS --- //
{ id: 'Glimmerscale6', name: 'Draconic Concord', color: 'green', difficulty: '⭐⭐⭐⭐⭐⭐',
  image: 'Avatar/VerdarokSylvanThornwing.png', bannerArt: 'CardImages/Banner/GreenBanner.png', cardbackArt: 'OtherImages/Cardback/CBFairy.png',
  cards: [ { id: 'Verdara', amount: 1 },
      { id: 'SylvaniaThornEmpress', amount: 1 },      
...
function renderModePlayerDeckTile() {
  ...
  slotDiv.innerHTML = `
    ...
    <img class="deck-slot-cardback-img" src="${deckObj.cardbackArt || "OtherImages/Cardback/DefaultCardback.png"}" alt="Cardback" style="position:absolute;right:8px;width:32px;height:44px;">
